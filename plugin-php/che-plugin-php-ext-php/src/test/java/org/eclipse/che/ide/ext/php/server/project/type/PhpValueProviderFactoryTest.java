...
/**
 * Testing {@link PhpValueProviderFactory} functionality.
 *
 * @author Roman Nikitenko.
 */
public class PhpValueProviderFactoryTest {
    private static final String workspace = "my_ws";

    private ProjectManager          pm;
    private PhpValueProviderFactory phpValueProviderFactory;
    ...
    public void setUp() throws Exception {
        ...
        phpValueProviderFactory = new PhpValueProviderFactory();
        projectTypes.add(new PhpProjectType(phpValueProviderFactory));
    ...
    @Test
    public void testGetValuesWhenProjectContainsPhpFiles() throws Exception {
        ...
        List<String> values = phpValueProviderFactory.newInstance(baseFolder).getValues(HAS_PHP_FILES);
    ...
    @Test
    public void testGetValuesWhenProjectNotContainsPhpFiles() throws Exception {
        Project phpProject = pm.createProject(workspace, "phpProject",
                                             new ProjectConfig("test project", "php", new HashMap<>(), null, null, null), null, null);
        FolderEntry baseFolder = phpProject.getBaseFolder();
