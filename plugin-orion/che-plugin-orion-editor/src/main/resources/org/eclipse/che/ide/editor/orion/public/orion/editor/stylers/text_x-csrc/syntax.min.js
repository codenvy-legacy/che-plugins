...
{include:"orion.lib#number_hex"},{match:"\\b(?:"+b.join("|")+")\\b",name:"keyword.operator.c"}],repository:{directive:{match:"#\\s*(?:"+c.join("|")+")\\b[^$]*",name:"meta.preprocessor.c"}}});return{id:a[a.length-1].id,grammars:a,keywords:b.concat(c)}});