...
public class Machine {
    ...
    public String getWsServerExtensionsUrl() {
        String url = "";
        Map<String, ServerDto> serverDescriptors = descriptor.getRuntime().getMetadata().getServers();
    ...
    public Map<String, String> getProperties() {
        return descriptor.getRuntime().getMetadata().getProperties();
    }
    ...
    public List<Server> getServersList() {
        ...
        Map<String, ServerDto> servers = descriptor.getRuntime().getMetadata().getServers();
