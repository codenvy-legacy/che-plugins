...
public class Repository {
     ...
     *
     * @param id
     *         new repository identifier, if it is {@code null} then <i>id</i> element will be removed from xml if exists
     */
     ...
     *
     * @param name
     *         new repository name, if it is {@code null} then <i>name</i> element will be removed from xml if exists
     */
     ...
     *
     * @param url
     *         new repository url, if it is {@code null} then <i>url</i> element will be removed from xml if exists
     */
     ...
     *
     * @param layout
     *         new repository layout, if {@code null} then <i>layout</i> element will be removed from xml if exists
     */
    public Repository setLayout(String layout) {
        ...
        if (element != null) {
            if (layout == null) {
                ...
                element.insertChild(createElement("layout", layout), beforeAnyOf("snapshots", "releases").or(inTheEnd()));
            }
        }
        return this;
    }
     ...
     *
     * @param snapshots
     *         new repository snapshots details, if {@code null} then element will be removed from xml if exists
     */
    public Repository setSnapshots(RepositoryPolicy snapshots) {
        ...
        if (element != null) {
            if (snapshots == null) {
                ...
                snapshots.element = element.getSingleChild("snapshots").replaceWith(snapshots.asXMLElement("snapshots"));
            } else {
     ...
     *
     * @param releases new repository releases details, if {@code null} then element will be removed from xml if exists
     */
    public Repository setReleases(RepositoryPolicy releases) {
        ...
        if (element != null) {
            if (releases == null) {
                ...
                releases.element = element.getSingleChild("releases").replaceWith(releases.asXMLElement("releases"));
            } else {
