...
public abstract class MavenServerWrapper extends RmiObjectWrapper<MavenServer> {
    ...
    public void customize(MavenWorkspaceCache cache, MavenTerminal mavenTerminal,
        ...
        try {
            UnicastRemoteObject.exportObject(notifier, 0);
        } catch (RemoteException e) {
            throw new RuntimeException(e);
        }


        customization = new MavenCustomization(cache, mavenTerminal, notifier, failOnUnresolvedDependency, alwaysUpdateSnapshot);
