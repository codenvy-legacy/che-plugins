...
public class MavenProjectManager {
    ...
    private MavenProject findParentProject(MavenProject mavenProject) {
        readLock.lock();
        try {
    ...
    private void internalUpdate(MavenProject mavenProject, MavenProject parentProject, boolean isNew, boolean recursive, UpdateState state,
        ...
        try {
            ...
            //TODO provide notifier interface that does not throw remote exception
            e.printStackTrace();
        }
    ...
    private List<MavenProject> findModules(MavenProject parent) {
        readLock.lock();
        try {
    ...
    private MavenProject findMavenProject(IProject project) {
        readLock.lock();
        try {
