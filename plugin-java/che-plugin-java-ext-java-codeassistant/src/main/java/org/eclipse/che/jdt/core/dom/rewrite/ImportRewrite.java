...
package org.eclipse.che.jdt.core.dom.rewrite;
...
import org.eclipse.che.jdt.internal.core.dom.rewrite.ImportRewriteAnalyzer;
...
/**
 * The {@link org.eclipse.jdt.core.dom.rewrite.ImportRewrite} helps updating imports following a import order and on-demand imports threshold as configured by a project.
 * <p>
...
public final class ImportRewrite {
	...
	/**
	 * A {@link org.eclipse.jdt.core.dom.rewrite.ImportRewrite.ImportRewriteContext} can optionally be used in e.g. {@link org.eclipse.jdt.core.dom.rewrite.ImportRewrite#addImport(String, org.eclipse.jdt.core.dom.rewrite.ImportRewrite.ImportRewriteContext)} to
	...
	/**
	 * Creates an {@link org.eclipse.jdt.core.dom.rewrite.ImportRewrite} from an {@link ICompilationUnit}. If
	 * <code>restoreExistingImports</code>
	 ...
	 */
	public static ImportRewrite create(ICompilationUnit cu, boolean restoreExistingImports)
	...
	/**
	 * Creates an {@link ImportRewrite} from an AST ({@link CompilationUnit}). The AST has to be created
	 * from an
	 * {@link ICompilationUnit}, that means {@link CheASTParser#setSource(ICompilationUnit)} has been used when creating the
