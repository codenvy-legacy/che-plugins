...
//                String message = NLS.bind(PrefsMessages.preferences_failedDelete, location);
                JavaPlugin.log(new Status(IStatus.WARNING, PrefsMessages.OWNER_NAME, IStatus.WARNING, "preferences save failed, file was delete", null));
            }
            return;
        }
...
//            String message = NLS.bind(PrefsMessages.preferences_saveException, location);
            JavaPlugin.log(new Status(IStatus.ERROR, PrefsMessages.OWNER_NAME, IStatus.ERROR, "preferences_saveException", e));
