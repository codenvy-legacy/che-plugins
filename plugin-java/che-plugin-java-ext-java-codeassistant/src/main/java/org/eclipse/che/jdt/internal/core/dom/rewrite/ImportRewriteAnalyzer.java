 ...
 *******************************************************************************/
package org.eclipse.che.jdt.internal.core.dom.rewrite;
...
import org.eclipse.che.jdt.core.search.TypeNameRequestor;
...
public final class ImportRewriteAnalyzer {
	...
	private int getSpacesBetweenImportGroups() {
		try {
			int num = Integer.parseInt(this.compilationUnit.getJavaProject().getOption(
					DefaultCodeFormatterConstants.FORMATTER_BLANK_LINES_BETWEEN_IMPORT_GROUPS, true));
			if (num >= 0)
				return num;
	...
	private boolean insertSpaceBeforeSemicolon() {
		return JavaCore.INSERT.equals(this.compilationUnit.getJavaProject()
