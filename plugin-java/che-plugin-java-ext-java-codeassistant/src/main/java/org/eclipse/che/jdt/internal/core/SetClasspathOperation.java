...
public class SetClasspathOperation extends ChangeClasspathOperation {
	...
	protected void executeOperation() throws JavaModelException {
		...
		try {
			...
			ClasspathChange classpathChange = perProjectInfo
					.setRawClasspath(this.newRawClasspath, this.referencedEntries, this.newOutputLocation, JavaModelStatus
							.VERIFIED_OK/*format is ok*/);
			...
			if (this.canChangeResources &&
				perProjectInfo.writeAndCacheClasspath(this.project, this.newRawClasspath, this.newOutputLocation))
