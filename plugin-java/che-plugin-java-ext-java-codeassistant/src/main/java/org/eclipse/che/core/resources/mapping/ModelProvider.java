 ...
 *******************************************************************************/
package org.eclipse.che.core.resources.mapping;
...
public abstract class ModelProvider extends PlatformObject {
	...
	public boolean equals(Object obj) {
		if (obj instanceof org.eclipse.core.resources.mapping.ModelProvider) {
			org.eclipse.core.resources.mapping.ModelProvider other = (org.eclipse.core.resources.mapping.ModelProvider)obj;
	 ...
	 * {@link #getMappings( IResource[], org.eclipse.core.resources.mapping.ResourceMappingContext , IProgressMonitor)}
	 * or {@link #getMappings( ResourceTraversal[], org.eclipse.core.resources.mapping.ResourceMappingContext , IProgressMonitor)}
	 ...
	 */
	public ResourceMapping[] getMappings(IResource resource, org.eclipse.core.resources.mapping.ResourceMappingContext context, IProgressMonitor monitor) throws CoreException {
	 ...
	 * This method is used to map operations on resources to
	 * operations on resource mappings. By default, this method
	 * calls {@link #getMappings( IResource[], org.eclipse.core.resources.mapping.ResourceMappingContext , IProgressMonitor)}
	 ...
	 * @return the set of mappings that overlap with the given resource traversals
	 */
	public ResourceMapping[] getMappings(ResourceTraversal[] traversals, org.eclipse.core.resources.mapping.ResourceMappingContext context, IProgressMonitor monitor) throws CoreException {
