...
//		}
    ...
    public JavaModelException newNotPresentException() {
        return new org.eclipse.che.jdt.core.JavaModelException(newDoesNotExistStatus());
    }

    protected IJavaModelStatus newDoesNotExistStatus() {
        return new org.eclipse.che.jdt.internal.core.JavaModelStatus(IJavaModelStatusConstants.ELEMENT_DOES_NOT_EXIST, this);
    }
