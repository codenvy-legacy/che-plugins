...
/**
 * Java completion proposal for {@link org.eclipse.jdt.core.CompletionProposal#FIELD_REF_WITH_CASTED_RECEIVER}.
 *
 * @since 3.4
 */
public class JavaFieldWithCastedReceiverCompletionProposal extends JavaCompletionProposal {
    ...
    public JavaFieldWithCastedReceiverCompletionProposal(String completion, int start, int length, Image image, StyledString label,
                                                         int relevance, boolean inJavadoc,
