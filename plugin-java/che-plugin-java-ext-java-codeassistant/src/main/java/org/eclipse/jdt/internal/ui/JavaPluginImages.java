...
public class JavaPluginImages {
    ...
    public static final ImageDescriptor DESC_OBJS_ANNOTATION_DEFAULT   = new ImageDescriptor("defaultAnnotation");
    public static final ImageDescriptor DESC_OBJS_ANNOTATION_PRIVATE   = new ImageDescriptor("privateAnnotation");
    public static final ImageDescriptor DESC_OBJS_ANNOTATION_PROTECTED = new ImageDescriptor("protectedAnnotation");
    ...
    public static final ImageDescriptor DESC_OBJS_ENUM_PROTECTED = new ImageDescriptor("protectedEnum");
    ...
    public static final ImageDescriptor DESC_OBJS_INTERFACE_DEFAULT         = new ImageDescriptor("defaultInterface");
    public static final ImageDescriptor DESC_OBJS_INNER_INTERFACE_PUBLIC    = new ImageDescriptor("innerInterfacePublic");
    public static final ImageDescriptor DESC_OBJS_INNER_INTERFACE_PRIVATE   = new ImageDescriptor("innerInterfacePrivate");
    public static final ImageDescriptor DESC_OBJS_INNER_INTERFACE_PROTECTED = new ImageDescriptor("innerInterfaceProtected");
    ...
    public static final ImageDescriptor DESC_OBJS_INNER_CLASS_PUBLIC    = new ImageDescriptor("innerClassPublic");
    public static final ImageDescriptor DESC_OBJS_INNER_CLASS_PRIVATE   = new ImageDescriptor("innerClassPrivate");
    public static final ImageDescriptor DESC_OBJS_INNER_CLASS_PROTECTED = new ImageDescriptor("innerClassProtected");
    public static final ImageDescriptor DESC_OBJS_INNER_CLASS_DEFAULT   = new ImageDescriptor("innerClassDefault");
    ...
    public static final ImageDescriptor DESC_OBJS_CLASSFOLDER_WSRC        = new ImageDescriptor("classfolderWSRC");
    public static final ImageDescriptor DESC_OBJS_PACKFRAG_ROOT           = new ImageDescriptor("packageFragmentRoot");
    ...
    public static final ImageDescriptor DESC_OBJS_EMPTY_PACKAGE_RESOURCES = new ImageDescriptor("emptyPackage");
    ...
    public static final ImageDescriptor IMG_CORRECTION_CHANGE        = new ImageDescriptor("correctionChange");
    ...
    public static final ImageDescriptor IMG_CORRECTION_REMOVE        = new ImageDescriptor("correctionRemove");
