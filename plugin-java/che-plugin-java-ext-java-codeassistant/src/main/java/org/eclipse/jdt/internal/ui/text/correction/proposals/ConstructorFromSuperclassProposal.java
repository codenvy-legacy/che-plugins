...
public class ConstructorFromSuperclassProposal extends LinkedCorrectionProposal {
	...
	public ConstructorFromSuperclassProposal(ICompilationUnit cu, TypeDeclaration typeNode, IMethodBinding superConstructor,
											 int relevance) {
...
//														  );
	...
	public String getName() {
		...
		buf.append(')');
		return Messages.format(CorrectionMessages.ConstructorFromSuperclassProposal_description,
