...
//                            else
	 ...
	 * <li>the {@linkplain #computeTypeProposal(org.eclipse.jdt.core.ITypeParameter) parameter proposal} for unbounded
	 ...
	 * @throws org.eclipse.jdt.core.JavaModelException if extracting the super type signatures
...
//			ui.enter();
			...
			fSelectedRegion=  new Region(replacementOffset + replacementString.length(),0); //ui.getSelectedRegion();
...
//				message == null ? e.toString() : message);
	 ...
	 * @see org.eclipse.jdt.core.CompletionProposal#canUseDiamond(org.eclipse.jdt.core.CompletionContext)
	 * @since 3.7
	 */
