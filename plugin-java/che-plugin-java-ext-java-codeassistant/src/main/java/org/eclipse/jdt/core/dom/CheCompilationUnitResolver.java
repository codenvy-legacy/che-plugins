...
public class CheCompilationUnitResolver extends CompilationUnitResolver {
	 ...
	 */
	public CheCompilationUnitResolver(INameEnvironment environment, IErrorHandlingPolicy policy,
									  CompilerOptions compilerOptions, ICompilerRequestor requestor,
									  IProblemFactory problemFactory, IProgressMonitor monitor, boolean fromJavaProject) {
	...
	@Override
	public void accept(ISourceType[] sourceTypes, org.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding,
