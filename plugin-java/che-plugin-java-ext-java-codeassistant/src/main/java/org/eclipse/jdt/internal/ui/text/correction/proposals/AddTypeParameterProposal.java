...
public class AddTypeParameterProposal extends LinkedCorrectionProposal {
	...
	public AddTypeParameterProposal(ICompilationUnit targetCU, IBinding binding, CompilationUnit astRoot, String name,
									ITypeBinding[] bounds, int relevance) {
		...
		if (binding instanceof IMethodBinding) {
			String[] args =
					{BasicElementLabels.getJavaElementName(fTypeParamName), ASTResolving.getMethodSignature((IMethodBinding)binding)};
