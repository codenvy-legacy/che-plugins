...
public class CompilationUnitRewriteOperationsFix extends AbstractFix {
	...
	public abstract static class CompilationUnitRewriteOperation {
		...
		protected Type importType(final ITypeBinding toImport, final ASTNode accessor, ImportRewrite imports, final CompilationUnit compilationUnit) {
			ImportRewriteContext
					importContext= new ContextSensitiveImportRewriteContext(compilationUnit, accessor.getStartPosition(), imports);
	...
	public CompilationUnitRewriteOperationsFix(String name, CompilationUnit compilationUnit, CompilationUnitRewriteOperation[]
			operations) {
		super(name);
...
//	}
	...
	public CompilationUnitChange createChange(IProgressMonitor progressMonitor) throws CoreException {
		CompilationUnitRewrite cuRewrite =
				new CompilationUnitRewrite((ICompilationUnit)fCompilationUnit.getJavaElement(), fCompilationUnit);
		...
		if (result == null)
			throw new CoreException(new Status(IStatus.ERROR, JavaPlugin.ID_PLUGIN,
											   Messages.format(FixMessages.CompilationUnitRewriteOperationsFix_nullChangeError,
															   getDisplayString())));
