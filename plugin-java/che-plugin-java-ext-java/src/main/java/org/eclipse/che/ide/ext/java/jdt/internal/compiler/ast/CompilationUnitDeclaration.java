...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.impl.IrritantSet;
...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.parser.NLSTag;
...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.util.HashSetOfInt;
...
public class CompilationUnitDeclaration extends ASTNode implements ProblemSeverities, ReferenceContext {
                                        ...
                                        for (int iToken = 0, tokenCount = inits.length; iToken < tokenCount; iToken++) {
                                            ...
                                            if (cst != Constant.NotAConstant && cst.typeID() == TypeIds.T_JavaLangString) {
                                                ...
                                                if (tokenIrritants != null
                                                    ...
                                                    && (foundIrritants[iSuppress] == null || !foundIrritants[iSuppress]
                                                        .isAnySet(tokenIrritants))) { // if irritant had no matching problem
    ...
    public void recordStringLiteral(StringLiteral literal, boolean fromRecovery) {
        ...
        if (this.stringLiterals == null) {
            ...
            if (this.stringLiteralsPtr == stackLength) {
                System.arraycopy(this.stringLiterals, 0, this.stringLiterals =
                        new StringLiteral[stackLength + STRING_LITERALS_INCREMENT], 0, stackLength);
            }
        }
    ...
    public void recordSuppressWarnings(IrritantSet irritants, Annotation annotation, int scopeStart, int scopeEnd) {
        if (this.suppressWarningIrritants == null) {
            ...
            System.arraycopy(this.suppressWarningIrritants, 0, this.suppressWarningIrritants =
                    new IrritantSet[2 * this.suppressWarningsCount], 0, this.suppressWarningsCount);
            System.arraycopy(this.suppressWarningAnnotations, 0, this.suppressWarningAnnotations =
                    new Annotation[2 * this.suppressWarningsCount], 0, this.suppressWarningsCount);
            System.arraycopy(this.suppressWarningScopePositions, 0, this.suppressWarningScopePositions =
                    new long[2 * this.suppressWarningsCount], 0, this.suppressWarningsCount);
        }
    ...
    public void record(LocalTypeBinding localType) {
        if (this.localTypeCount == 0) {
            ...
            System.arraycopy(this.localTypes, 0, (this.localTypes = new LocalTypeBinding[this.localTypeCount * 2]), 0,
                             this.localTypeCount);
        }
        ...
        if (this.types != null && isPackageInfo) {
            ...
            if (syntheticTypeDeclaration.javadoc == null) {
                syntheticTypeDeclaration.javadoc =
                        new Javadoc(syntheticTypeDeclaration.declarationSourceStart,
