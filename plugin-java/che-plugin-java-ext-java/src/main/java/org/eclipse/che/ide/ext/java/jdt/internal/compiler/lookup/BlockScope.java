...
public class BlockScope extends Scope {
    ...
    */
    void computeLocalVariablePositions(int ilocal, int initOffset) {
        ...
        while (hasMoreVariables || hasMoreScopes) {
            if (hasMoreScopes && (!hasMoreVariables || (this.subscopes[iscope].startIndex() <= ilocal))) {
                ...
                if (this.subscopes[iscope] instanceof BlockScope) {
                    ...
                    subscope.computeLocalVariablePositions(0, subOffset);
    ...
    public Binding getBinding(char[][] compoundName, int mask, InvocationSite invocationSite, boolean needResolve) {
        ...
        while (currentIndex < length) {
            ...
            if ((mask & Binding.FIELD) != 0
                ...
                problemFieldBinding =
                        new ProblemFieldBinding(((ProblemFieldBinding)binding).closestMatch,
            ...
            if ((binding = findMemberType(nextName, referenceBinding)) == null) {
                ...
                return new ProblemReferenceBinding(CharOperation.subarray(compoundName, 0, currentIndex), referenceBinding,
                                                   ProblemReasons.NotFound);
            }
        ...
        if ((mask & Binding.FIELD) != 0 && (binding instanceof FieldBinding)) {
            ...
            if (!field.isStatic())
                return new ProblemFieldBinding(field, field.declaringClass, CharOperation.concatWith(
    ...
    public final Binding getBinding(char[][] compoundName, InvocationSite invocationSite) {
        ...
        while (currentIndex < length) {
            ...
            if (typeBinding == null) {
                return new ProblemFieldBinding(null, null, CharOperation.concatWith(
            ...
            if (variableBinding == null) {
                return new ProblemFieldBinding(null, receiverType instanceof ReferenceBinding
                                                     ? (ReferenceBinding)receiverType : null, CharOperation.concatWith(
                        CharOperation.subarray(compoundName, 0, currentIndex), '.'), ProblemReasons.NotFound);
            }
    ...
    public Object[] getEmulationPath(ReferenceBinding targetEnclosingType, boolean onlyExactMatch,
        ...
        if (!currentMethodScope.isStatic && !currentMethodScope.isConstructorCall) {
            if (sourceType == targetEnclosingType
        ...
        if (insideConstructor) {
            ...
            if ((syntheticArg = ((NestedTypeBinding)sourceType).getSyntheticArgument(targetEnclosingType, onlyExactMatch)) != null) {
                ...
                if (denyEnclosingArgInConstructorCall
                    ...
                    && (sourceType == targetEnclosingType || (!onlyExactMatch && sourceType
        ...
        if (sourceType.isAnonymousType()) {
            ...
            if (enclosingType.isNestedType()) {
                ...
                SyntheticArgumentBinding enclosingArgument =
                        nestedEnclosingType.getSyntheticArgument(nestedEnclosingType.enclosingType(), onlyExactMatch);
                if (enclosingArgument != null) {
                    FieldBinding syntheticField = sourceType.getSyntheticField(enclosingArgument);
                    if (syntheticField != null) {
                        if (syntheticField.type == targetEnclosingType
