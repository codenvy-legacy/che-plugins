...
public class CompilationResult {
    ...
    private Set<CategorizedProblem> firstErrors;
    ...
    private static final Comparator<CategorizedProblem> PROBLEM_COMPARATOR = new Comparator<CategorizedProblem>() {
    ...
    public void record(CategorizedProblem newProblem, ReferenceContext referenceContext) {
        ...
        if (referenceContext != null) {
            ...
            if (this.firstErrors == null)
                this.firstErrors = new HashSet<CategorizedProblem>(5);
