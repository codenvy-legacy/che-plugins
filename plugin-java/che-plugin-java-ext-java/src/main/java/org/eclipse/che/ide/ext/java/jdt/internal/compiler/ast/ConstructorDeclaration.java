...
public class ConstructorDeclaration extends AbstractMethodDeclaration {
    ...
    /**
     * @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration#analyseCode(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ClassScope,
     *      org.eclipse.che.ide.ext.java.jdt.internal.compiler.flow.InitializationFlowContext, org.eclipse.che.ide.ext.java.jdt.internal.compiler.flow.FlowInfo)
    ...
    /**
     * The flowInfo corresponds to non-static field initialization infos. It may be unreachable (155423), but still the explicit constructor
     * call must be
    ...
    public void analyseCode(ClassScope classScope, InitializationFlowContext initializerFlowContext, FlowInfo flowInfo,
        ...
        try {
            ExceptionHandlingFlowContext constructorContext =
                    new ExceptionHandlingFlowContext(initializerFlowContext.parent, this, this.binding.thrownExceptions,
                                                     initializerFlowContext, this.scope, FlowInfo.DEAD_END);
            ...
            if (this.statements != null) {
                int complaintLevel =
                        (nonStaticFieldInfoReachMode & FlowInfo.UNREACHABLE) == 0 ? Statement.NOT_COMPLAINED
                ...
                for (int i = 0, count = fields.length; i < count; i++) {
                    ...
                    if ((!(field = fields[i]).isStatic()) && field.isFinal() && (!flowInfo.isDefinitelyAssigned(fields[i]))) {
                        this.scope.problemReporter().uninitializedBlankFinalField(field,
                                                                                  ...
                                                                                  ? (ASTNode)this.scope.referenceType() : this);
                    }
                }
            }
    ...
    public boolean isRecursive(ArrayList visited) {
        if (this.binding == null || this.constructorCall == null || this.constructorCall.binding == null
            || this.constructorCall.isSuperAccess() || !this.constructorCall.binding.isValidBinding()) {
            return false;
        }
