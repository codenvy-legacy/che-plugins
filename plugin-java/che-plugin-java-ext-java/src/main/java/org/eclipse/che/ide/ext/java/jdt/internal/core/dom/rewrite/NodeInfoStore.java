...
public final class NodeInfoStore {
    ...
    private Set<ASTNode> collapsedNodes;
     ...
     *
     * @param target
     *         The node at the target site. Can be a placeholder node but also the source node itself.
     * @param copySource
     ...
     *
     * @param nodeType
     *         Type of the node to create. Use the type constants in {@link NodeInfoStore}.
    ...
    public Block createCollapsePlaceholder() {
        ...
        if (this.collapsedNodes == null) {
            this.collapsedNodes = new HashSet<ASTNode>();
        }
    ...
    private void setPlaceholderData(ASTNode node, PlaceholderData data) {
        if (this.placeholderNodes == null) {
            this.placeholderNodes = new IdentityHashMap<ASTNode, PlaceholderData>();
        }
