...
public class IrritantSet {
    ...
    static {
        COMPILER_DEFAULT_WARNINGS
                ...
                .set(
                        CompilerOptions.MethodWithConstructorName | CompilerOptions.OverriddenPackageDefaultMethod
                ...
                .set(
                        CompilerOptions.UncheckedTypeOperation | CompilerOptions.FinalParameterBound
                ...
                .set(CompilerOptions.DeadCode | CompilerOptions.Tasks);

        ALL.setAll();
        HIDING.set(CompilerOptions.FieldHiding).set(CompilerOptions.LocalVariableHiding).set(CompilerOptions.TypeHiding);
        NULL.set(CompilerOptions.PotentialNullReference).set(CompilerOptions.RedundantNullCheck);
        RESTRICTION.set(CompilerOptions.DiscouragedReference);
        STATIC_ACCESS.set(CompilerOptions.NonStaticAccessToStatic);
        UNUSED.set(CompilerOptions.UnusedArgument).set(CompilerOptions.UnusedPrivateMember)
              .set(CompilerOptions.UnusedDeclaredThrownException).set(CompilerOptions.UnusedLabel)
              .set(CompilerOptions.UnusedImport).set(CompilerOptions.UnusedTypeArguments)
              .set(CompilerOptions.RedundantSuperinterface).set(CompilerOptions.DeadCode)
              .set(CompilerOptions.UnusedObjectAllocation).set(CompilerOptions.RedundantSpecificationOfTypeArguments);
        STATIC_METHOD.set(CompilerOptions.MethodCanBePotentiallyStatic);
        String suppressRawWhenUnchecked = "true"; //TODO //System.getProperty("suppressRawWhenUnchecked"); //$NON-NLS-1$
