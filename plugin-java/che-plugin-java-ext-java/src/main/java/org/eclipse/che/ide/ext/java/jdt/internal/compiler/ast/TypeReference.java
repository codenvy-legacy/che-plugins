...
public abstract class TypeReference extends Expression {
    ...
    protected TypeBinding internalResolveType(Scope scope) {
        ...
        if (!(this instanceof QualifiedTypeReference)
            // QualifiedTypeReference#getTypeBinding called above will have already checked deprecation
    ...
    public TypeBinding resolveSuperType(ClassScope scope) {
        ...
        if (superType.isTypeVariable()) {
            if (this.resolvedType.isValidBinding()) {
                this.resolvedType =
                        new ProblemReferenceBinding(getTypeName(), (ReferenceBinding)this.resolvedType,
