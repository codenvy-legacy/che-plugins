...
abstract public class ReferenceBinding extends TypeBinding {
                ...
                if (!(receiverType == this || receiverType == enclosingType())) {
                    ...
                    if (receiverType.isTypeVariable()) {
                        ...
                        if (typeVariable.environment.globalOptions.complianceLevel <= ClassFileConstants.JDK1_6
                            && (typeVariable.isErasureBoundTo(erasure()) || typeVariable.isErasureBoundTo(enclosingType()
                                                                                                                  .erasure())))
                            break receiverCheck;
                    }
                    return false;
    ...
    public char[] computeGenericTypeSignature(TypeVariableBinding[] typeVariables) {
        ...
        boolean isMemberOfGeneric =
                isMemberType() && (enclosingType().modifiers & ExtraCompilerModifiers.AccGenericSignature) != 0;
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.env.IDependent#getFileName() */
    ...
    public boolean implementsInterface(ReferenceBinding anInterface, boolean searchHierarchy) {
        ...
        do {
            ...
            if (itsInterfaces != null && itsInterfaces !=
                                         Binding.NO_SUPERINTERFACES) { // in code assist cases when source types are added late,
                                         // may not be finished connecting hierarchy
                if (interfacesToVisit == null) {
                    interfacesToVisit = itsInterfaces;
                    nextPosition = interfacesToVisit.length;
                } else {
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#isThrowable() */
     ...
     *
     * @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#isUncheckedException(boolean)
     */
