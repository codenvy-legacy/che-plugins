...
/**
 * A binding resolver is an internal mechanism for figuring out the binding for a major declaration, type, or name reference. This
 * also handles the creation and mapping between annotations and the ast nodes that define them.
 * <p>
 * The default implementation serves as the default binding resolver that does no resolving whatsoever. Internal subclasses do all
 * the real work.
 * </p>
 *
...
public class BindingResolver {
    ...
    /**
     * Finds the corresponding AST node from which the given binding originated. Returns <code>null</code> if the binding does not
     * correspond to any node in the compilation unit.
     * <p>
     ...
     * <li>class or interface - a <code>TypeDeclaration</code> or a <code>ClassInstanceCreation</code> (for anonymous classes)</li>
     ...
     * <p/>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement. </p>
     *
     * @param bindingKey
     *         the binding key
     * @return the corresponding node where the bindings is declared, or <code>null</code> if none
     ...
     */
    org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
        return null;
    }
     ...
     */
    IMethodBinding getMethodBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding methodBinding) {
        return null;
    }
     ...
     */
    IPackageBinding getPackageBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding packageBinding) {
        return null;
    }
    ...
    /**
     * Returns the new type binding corresponding to the given variableDeclaration. This is used for recovered binding only.
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     *
     ...
     * </p>
     *
     * @param recoveredTypeBinding
     *         the recovered type binding
     * @param dimensions
     *         the dimensions to add the to given type binding dimensions
     * @return the new type binding
     */
     ...
     *
     * @param binding
     *         the old variable binding
     * @return the new variable binding
     */
    IVariableBinding getVariableBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.VariableBinding binding) {
        return null;
    }
     ...
     */
    IAnnotationBinding getAnnotationInstance(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding instance) {
        return null;
    }
     ...
     * </p>
     * <p>
     * Note 1: enum constants are not considered constant expressions either. The result is always <code>null</code> for these.
     * </p>
     * <p>
     ...
     * <p>
     * The implementation of <code>ClassInstanceCreation.resolveConstructor</code> forwards to this method. Which constructor is
     * invoked is often a function of the context in which the expression node is embedded as well as the expression subtree
     * itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     ...
     * @return the binding for the constructor being invoked, or <code>null</code> if no binding is available
     */
     ...
     * Resolves and returns the binding for the constructor being invoked.
     * <p>
     * The implementation of <code>ConstructorInvocation.resolveConstructor</code> forwards to this method. Which constructor is
     * invoked is often a function of the context in which the expression node is embedded as well as the expression subtree
     * itself.
     * </p>
     * <p>
     ...
     * Resolves and returns the binding for the constructor being invoked.
     * <p>
     * The implementation of <code>SuperConstructorInvocation.resolveConstructor</code> forwards to this method. Which constructor
     * is invoked is often a function of the context in which the expression node is embedded as well as the expression subtree
     * itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     ...
     * <p>
     * The implementation of <code>Expression.resolveTypeBinding</code> forwards to this method. The result is often a function of
     * the context in which the expression node is embedded as well as the expression subtree itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * @return the binding for the type of the given expression, or <code>null</code> if no binding is available
     */
     ...
     * <p>
     * The implementation of <code>FieldAccess.resolveFieldBinding</code> forwards to this method. How the field resolves is often
     * a function of the context in which the field access node is embedded as well as the field access subtree itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * @return the binding for the given field access, or <code>null</code> if no binding is available
     */
     ...
     * <p>
     * The implementation of <code>SuperFieldAccess.resolveFieldBinding</code> forwards to this method. How the field resolves is
     * often a function of the context in which the super field access node is embedded as well as the super field access subtree
     * itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     ...
     * @return the binding for the given package declaration, or the package binding (for on-demand imports) or type binding (for
     *         single-type imports), or <code>null</code> if no binding is available
     */
     ...
     * <p>
     * The implementation of <code>AnnotationTypeMemberDeclaration.resolveBinding</code> forwards to this method. How the
     * declaration resolves is often a function of the context in which the declaration node is embedded as well as the declaration
     * subtree itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     ...
     *
     * @param member
     *         the annotation type member declaration of interest
     * @return the binding for the given annotation type member declaration, or <code>null</code> if no binding is available
     * @since 3.0
     */
     ...
     * <p>
     * The implementation of <code>MethodDeclaration.resolveBinding</code> forwards to this method. How the method resolves is
     * often a function of the context in which the method declaration node is embedded as well as the method declaration subtree
     * itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     ...
     * @return the binding for the given method declaration, or <code>null</code> if no binding is available
     */
     ...
     * <p>
     * The implementation of <code>MethodInvocation.resolveMethodBinding</code> forwards to this method. How the method resolves is
     * often a function of the context in which the method invocation node is embedded as well as the method invocation subtree
     * itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     ...
     * @return the binding for the given method invocation, or <code>null</code> if no binding is available
     */
     ...
     * <p>
     * The implementation of <code>Name.resolveBinding</code> forwards to this method. How the name resolves is often a function of
     * the context in which the name node is embedded as well as the name itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * @return the binding for the given package declaration, or <code>null</code> if no binding is available
     */
     ...
     * <p>
     * The implementation of <code>MemberRef.resolveBinding</code> forwards to this method. How the name resolves is often a
     * function of the context in which the name node is embedded as well as the name itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * <p>
     * The implementation of <code>MemberValuePair.resolveMemberValuePairBinding</code> forwards to this method. How the name
     * resolves is often a function of the context in which the name node is embedded as well as the name itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     *         the member value pair of interest
     * @return the binding for the member value pair, or <code>null</code> if no binding is available
     * @since 3.2
     */
     ...
     * Resolves the given reference and returns the binding for it.
     * <p>
     * The implementation of <code>MethodRef.resolveBinding</code> forwards to this method. How the name resolves is often a
     * function of the context in which the name node is embedded as well as the name itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     ...
     * Resolves the given annotation type declaration and returns the binding for it.
     * <p>
     * The implementation of <code>AnnotationTypeDeclaration.resolveBinding</code> forwards to this method. How the declaration
     * resolves is often a function of the context in which the declaration node is embedded as well as the declaration subtree
     * itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     ...
     *
     * @param type
     *         the annotation type declaration of interest
     * @return the binding for the given annotation type declaration, or <code>null</code> if no binding is available
     * @since 3.0
     */
     ...
     * <p>
     * The implementation of <code>AnonymousClassDeclaration.resolveBinding</code> forwards to this method. How the declaration
     * resolves is often a function of the context in which the declaration node is embedded as well as the declaration subtree
     * itself.
     * </p>
     * <p>
     ...
     *
     * @param type
     *         the anonymous class declaration of interest
     * @return the binding for the given class declaration, or <code>null</code> if no binding is available
     */
     ...
     * <p>
     * The implementation of <code>EnumDeclaration.resolveBinding</code> forwards to this method. How the enum declaration resolves
     * is often a function of the context in which the declaration node is embedded as well as the enum declaration subtree itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     *
     * @param type
     *         the enum declaration of interest
     * @return the binding for the given enum declaration, or <code>null</code> if no binding is available
     * @since 3.0
     */
     ...
     * <p>
     * The implementation of <code>Type.resolveBinding</code> forwards to this method. How the type resolves is often a function of
     * the context in which the type node is embedded as well as the type subtree itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * <p>
     * The implementation of <code>TypeDeclaration.resolveBinding</code> (and <code>TypeDeclarationStatement.resolveBinding</code>)
     * forwards to this method. How the type declaration resolves is often a function of the context in which the type declaration
     * node is embedded as well as the type declaration subtree itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * @return the binding for the given type declaration, or <code>null</code> if no binding is available
     */
     ...
     * <p>
     * The implementation of <code>TypeParameter.resolveBinding</code> forwards to this method. How the declaration resolves is
     * often a function of the context in which the declaration node is embedded as well as the declaration subtree itself.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * @return the binding for the given type parameter, or <code>null</code> if no binding is available
     * @since 3.1
     */
     ...
     * <p>
     * The implementation of <code>EnumConstantDeclaration.resolveVariable</code> forwards to this method.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * @param enumConstant
     *         the enum constant declaration of interest
     * @return the field binding for the given enum constant declaration, or <code>null</code> if no binding is available
     * @since 3.0
     */
     ...
     * <p>
     * The implementation of <code>VariableDeclaration.resolveBinding</code> forwards to this method. How the variable declaration
     * resolves is often a function of the context in which the variable declaration node is embedded as well as the variable
     * declaration subtree itself. VariableDeclaration declarations used as local variable, formal parameter and exception
     * variables resolve to local variable bindings; variable declarations used to declare fields resolve to field bindings.
     * </p>
     * <p>
     * The default implementation of this method returns <code>null</code>. Subclasses may reimplement.
     * </p>
     ...
     * @return the binding for the given variable declaration, or <code>null</code> if no binding is available
     */
     ...
     *
     * @param annotation
     *         the annotation ast node of interest
     * @return the DOM annotation representation for the given ast node, or <code>null</code> if none is available
     */
    ...
    /**
     * Returns the compilation unit scope used by this binding resolver. Returns <code>null</code> if none.
     *
