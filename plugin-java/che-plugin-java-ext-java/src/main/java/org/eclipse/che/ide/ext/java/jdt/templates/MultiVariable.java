 ...
 * key may be set via {@link #setKey(Object)}. Data sets are opaque {@link Object} arrays that are converted to the {@link String}
 * values expected by {@link org.eclipse.che.ide.ext.java.jdt.templates.api.TemplateVariable} using {@link Object#toString() toString}. The {@link #getCurrentChoice() choice} of
 * a master variable is the {@link #setKey(Object) key} for the slave variable.
 */
public class MultiVariable extends TemplateVariable {
     ...
     * @param key
     *         the key
     * @return the choices for this variable and the given set, or <code>null</code> if the set is not defined.
     */
