...
public class Block extends Statement {
    ...
    /** The list of statements (element type: {@link Statement}). Defaults to an empty list. */
    private ASTNode.NodeList statements = new ASTNode.NodeList(STATEMENTS_PROPERTY);

    /**
     * Creates a new unparented block node owned by the given AST. By default, the block is empty.
     * <p>
    ...
    /**
     * Returns the live list of statements in this block. Adding and removing nodes from this list affects this node dynamically.
     * All nodes in this list must be <code>Statement</code>s; attempts to add any other type of node will trigger an exception.
     *
     * @return the live list of statements in this block (element type: {@link Statement})
     */
