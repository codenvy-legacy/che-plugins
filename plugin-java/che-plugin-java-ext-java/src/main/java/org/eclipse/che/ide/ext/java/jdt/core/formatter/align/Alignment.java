 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.java.jdt.core.formatter.align;

import org.eclipse.che.ide.ext.java.jdt.core.formatter.Location;
import org.eclipse.che.ide.ext.java.jdt.core.formatter.Scribe;
...
public class Alignment {
    ...
    public Alignment(int kind, int mode, int tieBreakRule, Scribe scribe, int fragmentCount, int sourceRestart,
    ...
    public void checkColumn() {
        if ((this.mode & M_MULTICOLUMN) != 0 && this.fragmentCount > 0) {
            int currentIndentation =
                    this.scribe.getNextIndentationLevel(this.scribe.column + (this.scribe.needSpace ? 1 : 0));
    ...
    public String toString(StringBuffer buffer, int level) {
        ...
        buffer.append("<depth=") //$NON-NLS-1$
                ...
                .append(this.breakIndentationLevel).append("><shiftBreakIndent=") //$NON-NLS-1$
