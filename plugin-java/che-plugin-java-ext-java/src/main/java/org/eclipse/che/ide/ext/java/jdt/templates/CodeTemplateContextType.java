...
import org.eclipse.che.ide.ext.java.jdt.internal.core.dom.rewrite.TokenScanner;
   ...
   /* templates */
    ...
    public static class TagsVariableResolver extends TemplateVariableResolver {
        public TagsVariableResolver() {
            super(TAGS, JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_tags());
        }
    ...
    protected static class Todo extends TemplateVariableResolver {
        ...
        public Todo() {
            super("todo", JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_todo()); //$NON-NLS-1$
        }
    ...
    public CodeTemplateContextType(String contextName) {
        ...
        if (CATCHBLOCK_CONTEXTTYPE.equals(contextName)) {
            addResolver(new CodeTemplateVariableResolver(ENCLOSING_TYPE,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_enclosingtype
                                                                                     ()));
            addResolver(new CodeTemplateVariableResolver(ENCLOSING_METHOD,
                                                         JavaTemplateMessages.INSTANCE
                                                                             ...
                                                                             .CodeTemplateContextType_variable_description_enclosingmethod()));

            addResolver(new CodeTemplateVariableResolver(EXCEPTION_TYPE,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_exceptiontype()));
            addResolver(new CodeTemplateVariableResolver(EXCEPTION_VAR,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_exceptionvar()));
            ...
            addResolver(new CodeTemplateVariableResolver(BODY_STATEMENT,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_bodystatement()));
            ...
            addResolver(new CodeTemplateVariableResolver(FIELD,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_getterfieldname()));
            ...
            addResolver(new CodeTemplateVariableResolver(FIELD_TYPE,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_fieldtype()));
            addResolver(new CodeTemplateVariableResolver(FIELD,
                                                         JavaTemplateMessages.INSTANCE
            ...
            addResolver(new CodeTemplateVariableResolver(RETURN_TYPE,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_returntype()));
            addResolver(new TagsVariableResolver());
            addCompilationUnitVariables();
            fIsComment = true;
            ...
            addResolver(new CodeTemplateVariableResolver(SEE_TO_TARGET_TAG,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_see_target_tag()));
            addResolver(new TagsVariableResolver());
            addCompilationUnitVariables();
            fIsComment = true;
            ...
            addResolver(new CodeTemplateVariableResolver(FIELD_TYPE,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_getterfieldtype()));
            addResolver(new CodeTemplateVariableResolver(FIELD,
                                                         JavaTemplateMessages.INSTANCE
                                                                             .CodeTemplateContextType_variable_description_getterfieldname()));
            addResolver(new CodeTemplateVariableResolver(ENCLOSING_METHOD,
    ...
    private void addCompilationUnitVariables() {
        addResolver(new CodeTemplateVariableResolver(FILENAME,
                                                     JavaTemplateMessages.INSTANCE
                                                                         .CodeTemplateContextType_variable_description_filename()));
        addResolver(new CodeTemplateVariableResolver(PACKAGENAME,
                                                     JavaTemplateMessages.INSTANCE
                                                                         .CodeTemplateContextType_variable_description_packagename()));
        addResolver(new CodeTemplateVariableResolver(PROJECTNAME,
                                                     JavaTemplateMessages.INSTANCE
                                                                         .CodeTemplateContextType_variable_description_projectname()));
    }
    ...
    protected void validateVariables(TemplateVariable[] variables) throws TemplateException {
        ...
        for (int i = 0; i < variables.length; i++) {
            ...
            if (getResolver(type) == null) {
                ...
                throw new TemplateException(
                        JavaTemplateMessages.INSTANCE.CodeTemplateContextType_validate_unknownvariable(type));
            }
        ...
        if (!required.isEmpty()) {
            ...
            throw new TemplateException(
                    JavaTemplateMessages.INSTANCE.CodeTemplateContextType_validate_missingvariable(required.get(0)));
        }
    ...
    public void validate(String pattern) throws TemplateException {
        ...
        if (fIsComment) {
            if (!isValidComment(pattern)) {
                throw new TemplateException(JavaTemplateMessages.INSTANCE.CodeTemplateContextType_validate_invalidcomment());
            }
        }
    }
