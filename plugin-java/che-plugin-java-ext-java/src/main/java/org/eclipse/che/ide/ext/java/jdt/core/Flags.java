 ...
 * Specification. The AST class <code>Modifier</code> provides the same functionality as this class, only in the
...
public final class Flags {
    ...
    /**
     * Bridge method property flag (added in J2SE 1.5). Used to flag a compiler-generated bridge methods. See The Java Virtual
     * Machine Specification for more details.
     *
     * @since 3.0
     */
    ...
    /**
     * Varargs method property flag (added in J2SE 1.5). Used to flag variable arity method declarations. See The Java Virtual
     * Machine Specification for more details.
     *
     * @since 3.0
     */
    ...
    /**
     * Returns whether the given integer includes the indication that the element is deprecated (<code>@deprecated</code> tag in
     * Javadoc comment).
     *
     * @param flags
     *         the flags
    ...
    /**
     * Returns a standard string describing the given modifier flags. Only modifier flags are included in the output; deprecated,
     ...
     *   <code>static</code>
     *   <code>abstract</code> <code>final</code> <code>native</code> <code>synchronized</code> <code>transient</code> <code>volatile</code>
     * <code>strictfp</code>
     * </pre>
     * <p/>
     * This is a compromise between the orders specified in sections 8.1.1, 8.3.1, 8.4.3, 8.8.3, 9.1.1, and 9.3 of
     * <em>The Java Language
     * Specification, Second Edition</em> (JLS2).
     * </p>
     * <p>
     * Note that the flags of a method can include the AccVarargs flag that has no standard description. Since the AccVarargs flag
     * has the same value as the AccTransient flag (valid for fields only), attempting to get the description of method modifiers
     * with the AccVarargs flag set would result in an unexpected description. Clients should ensure that the AccVarargs is not
     * included in the flags of a method as follows:
     * <p/>
     * <pre>
     * IMethod method = ...
