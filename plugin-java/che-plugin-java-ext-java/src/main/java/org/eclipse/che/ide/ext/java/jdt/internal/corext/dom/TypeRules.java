...
import org.eclipse.che.ide.ext.java.jdt.internal.corext.refactoring.types.TType;
import org.eclipse.che.ide.ext.java.jdt.internal.corext.refactoring.types.TypeEnvironment;
...
public class TypeRules {
    ...
    public static boolean isJavaLangObject(ITypeBinding definedType) {
        return definedType.isTopLevel() && definedType.isClass()
     ...
     *
     * @param castType
     *         The binding of the type to cast to
     * @param bindingToCast
     *         The binding ef the expression to cast.
