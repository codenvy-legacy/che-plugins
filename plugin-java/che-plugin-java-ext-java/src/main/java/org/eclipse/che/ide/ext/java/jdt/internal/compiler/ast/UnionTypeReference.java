...
public class UnionTypeReference extends TypeReference {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.ast.TypeReference#copyDims(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.ast.TypeReference#getLastToken()
     */
    @Override
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayQualifiedTypeReference#getTypeBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.Scope) */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.ast.TypeReference#getTypeBinding(org.eclipse.che.ide.java.client.internal.compiler
     * .lookup.Scope)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.ast.TypeReference#getTypeName()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.ast.TypeReference#traverse(org.eclipse.che.ide.java.client.internal.compiler
     * .ASTVisitor, org.eclipse.che.ide.java.client.internal.compiler.lookup.BlockScope)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.ast.TypeReference#traverse(org.eclipse.che.ide.java.client.internal.compiler
     * .ASTVisitor, org.eclipse.che.ide.java.client.internal.compiler.lookup.ClassScope)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.ast.Expression#printExpression(int, java.lang.StringBuffer)
     */
    @Override
