...
public class ASTNodeFactory {
    ...
    public static ASTNode newStatement(AST ast, String content) {
        ...
        CompilationUnit root = (CompilationUnit)p.createAST();
     ...
     *
     * @param ast
     *         The AST to create the resulting type with.
     * @param declaration
     ...
     *         The variable declaration to get the type from
     * @param importRewrite
     *         the import rewrite to use, or <code>null</code>
     * @param context
     *         the import rewrite context, or <code>null</code>
     * @return a new type node created with the given AST.
     * @since 3.7.1
     */
    public static Type newType(AST ast, VariableDeclaration declaration, ImportRewrite importRewrite,
     ...
     *
     * @param ast
     *         The AST to create the expression for
     * @param type
     ...
     *
     * @param ast
     *         The AST to create the nodes for.
     * @param modifiers
     *         The modifier flags describing the modifier nodes to create.
