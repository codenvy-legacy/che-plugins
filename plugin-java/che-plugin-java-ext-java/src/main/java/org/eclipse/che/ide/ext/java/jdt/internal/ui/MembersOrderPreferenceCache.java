...
public class MembersOrderPreferenceCache {
    ...
    private static MembersOrderPreferenceCache instance;

    public static MembersOrderPreferenceCache get() {
        if (instance == null)
            instance = new MembersOrderPreferenceCache();
    ...
    private int[] getCategoryOffsets() {
        ...
        fillCategoryOffsetsFromPreferenceString(STR, offsets);
        //      if (!success)
        //      {
    ...
    private int[] getVisibilityOffsets() {
        ...
        fillVisibilityOffsetsFromPreferenceString(MODIFIERS, offsets);
        //      if (!success)
        //      {
        //         store.setToDefault(key);
