...
public class DefaultProblem extends CategorizedProblem {
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.core.compiler.CategorizedProblem#getCategoryID() */
     ...
     *
     * @return int
     * @see org.eclipse.che.ide.ext.java.jdt.core.compiler.IProblem#getID()
     */
    public int getID() {
        return this.id;
    }
     ...
     *
     * @see org.eclipse.che.ide.ext.java.jdt.core.compiler.CategorizedProblem#getMarkerType()
     */
