...
public abstract class VariableDeclaration extends ASTNode {
    ...
    /**
     * Returns structural property descriptor for the "extraDimensions" property of this node (type: {@link Integer}).
     *
    ...
    /**
     * Returns structural property descriptor for the "initializer" property of this node (child type: {@link Expression}).
     *
     * @return the property descriptor
     * @since 3.1
     */
     ...
     * <p>
     * For example, <code>int x[][]</code> has a type of <code>int</code> and two extra array dimensions; <code>int[][] x</code>
     * has a type of <code>int[][]</code> and zero extra array dimensions. The two constructs have different ASTs, even though
     * there are really syntactic variants of the same variable declaration.
     * </p>
     *
    ...
    /**
     * Returns the initializer of this variable declaration, or <code>null</code> if there is none.
     *
     * @return the initializer expression node, or <code>null</code> if there is none
     */
     ...
     *
     * @param initializer
     *         the initializer expression node, or <code>null</code> if there is none
     * @throws IllegalArgumentException
     *         if:
     *         <ul>
     *         <li>the node belongs to a different AST</li>
