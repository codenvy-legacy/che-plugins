        ...
        try {
            ...
            if ((thrownExceptions = this.binding.thrownExceptions) != Binding.NO_EXCEPTIONS) {
                ...
                flowContext.checkExceptionHandlers(thrownExceptions,
                                                   ...
                                                   ? (ASTNode)currentScope.methodScope().referenceContext : (ASTNode)this, flowInfo,
                                                   currentScope);
            }
        ...
        if ((flowInfo.tagBits & FlowInfo.UNREACHABLE_OR_DEAD) == 0) {
            ...
            if (superTypeErasure.isNestedType() && currentScope.enclosingSourceType().isLocalType()) {
                ...
                if (superTypeErasure.isLocalType()) {
                    ((LocalTypeBinding)superTypeErasure)
                            .addInnerEmulationDependent(currentScope, this.qualification != null);
                } else {
    ...
    public void resolve(BlockScope scope) {
        ...
        try {
            ...
            if (this.accessMode != ExplicitConstructorCall.This) {
                ...
                if (superclassRef != null && superclassRef.resolvedType != null
