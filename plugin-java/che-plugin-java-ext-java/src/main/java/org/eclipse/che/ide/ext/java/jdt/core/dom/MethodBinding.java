...
class MethodBinding implements IMethodBinding {
    ...
    private static final int VALID_MODIFIERS = Modifier.PUBLIC | Modifier.PROTECTED | Modifier.PRIVATE
                                               | Modifier.ABSTRACT | Modifier.STATIC | Modifier.FINAL | Modifier.SYNCHRONIZED |
                                               Modifier.NATIVE
                                               | Modifier.STRICTFP;

    private static final ITypeBinding[] NO_TYPE_BINDINGS = new ITypeBinding[0];

    private org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding binding;
    ...
    MethodBinding(BindingResolver resolver, org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding binding) {
    ...
    public IAnnotationBinding[] getParameterAnnotations(int index) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations =
        ...
        for (int i = 0; i < length; i++) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations =
    ...
    public ITypeBinding[] getParameterTypes() {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding[] parameters = this.binding.parameters;
    ...
    public ITypeBinding[] getExceptionTypes() {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding[] exceptions = this.binding.thrownExceptions;
    ...
    /**
     * @see org.eclipse.che.ide.ext.java.jdt.core.dom.IMethodBinding#isVarargs()
     * @since 3.1
     */
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding otherBinding = ((MethodBinding)other).binding;
        return BindingComparator.isEqual(this.binding, otherBinding);
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.core.dom.IMethodBinding#getTypeParameters() */
    ...
    /**
     * @see org.eclipse.che.ide.ext.java.jdt.core.dom.IMethodBinding#isGenericMethod()
     * @since 3.1
     */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.core.dom.IMethodBinding#getTypeArguments() */
    public ITypeBinding[] getTypeArguments() {
        ...
        if (this.binding instanceof ParameterizedGenericMethodBinding) {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding[] typeArgumentsBindings =
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.core.dom.IMethodBinding#isParameterizedMethod() */
    public boolean isParameterizedMethod() {
        return (this.binding instanceof ParameterizedGenericMethodBinding)
               && !((ParameterizedGenericMethodBinding)this.binding).isRaw;
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.core.dom.IMethodBinding#isRawMethod() */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.core.dom.IMethodBinding#getMethodDeclaration() */
