...
public class OperatorPrecedence {
    ...
    public static int getOperatorPrecedence(Operator operator) {
        if (operator == Operator.CONDITIONAL_OR) {
            ...
            return EQUALITY;
        } else if (operator == Operator.LESS || operator == Operator.LESS_EQUALS || operator == Operator.GREATER
                   || operator == Operator.GREATER_EQUALS) {
            return RELATIONAL;
        } else if (operator == Operator.LEFT_SHIFT || operator == Operator.RIGHT_SHIFT_SIGNED
