...
public interface IPackageBinding extends IBinding {
    ...
    /**
     * Returns the name of the package represented by this binding. For named packages, this is the fully qualified package name
     * (using "." for separators). For unnamed packages, this is an empty string.
     *
    ...
    /**
     * Returns whether this package is an unnamed package. See <em>The Java Language Specification</em> section 7.4.2 for details.
     *
    ...
    /**
     * Returns the list of name component making up the name of the package represented by this binding. For example, for the
     * package named "com.example.tool", this method returns {"com", "example", "tool"}. Returns the empty list for unnamed
     * packages.
     *
