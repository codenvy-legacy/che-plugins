...
import org.eclipse.che.ide.ext.java.jdt.core.dom.Modifier.ModifierKeyword;
...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ForeachStatement;
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocArgumentExpression;
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocFieldReference;
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocMessageSend;
...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.StringLiteralConcatenation;
...
import org.eclipse.che.ide.ext.java.jdt.internal.core.util.Util;
...
class ASTConverter {
    ...
    protected void buildBodyDeclarations(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration,
            AbstractTypeDeclaration typeDecl, boolean isInterface) {
        // add body declaration in the lexical order
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] members = typeDeclaration.memberTypes;
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration[] fields = typeDeclaration.fields;
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods =
        ...
        while ((fieldsIndex < fieldsLength) || (membersIndex < membersLength) || (methodsIndex < methodsLength)) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration nextFieldDeclaration = null;
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration nextMethodDeclaration = null;
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = null;
            ...
            switch (nextDeclarationType) {
                ...
                case 2:
                    membersIndex++;
                    AbstractTypeDeclaration node = convert(nextMemberDeclaration);
                    if (node == null) {
    ...
    protected void buildBodyDeclarations(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration enumDeclaration2,
            EnumDeclaration enumDeclaration) {
        // add body declaration in the lexical order
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] members = enumDeclaration2.memberTypes;
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration[] fields = enumDeclaration2.fields;
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods =
                enumDeclaration2.methods;
    ...
    protected void buildBodyDeclarations(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration expression,
            AnonymousClassDeclaration anonymousClassDeclaration) {
        // add body declaration in the lexical order
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] members = expression.memberTypes;
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration[] fields = expression.fields;
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = expression.methods;
    ...
    protected void checkAndAddMultipleFieldDeclaration(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration[] fields, int index, List bodyDeclarations) {
        if (fields[index] instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Initializer) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Initializer oldInitializer =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Initializer)fields[index];
    ...
    protected void checkAndAddMultipleLocalDeclaration(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement[] stmts, int index, List blockStatements) {
        if (index > 0
            && stmts[index - 1] instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration local1 =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)stmts[index - 1];
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration local2 =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)stmts[index];
            if (local1.declarationSourceStart == local2.declarationSourceStart) {
                ...
                // we can create a new FieldDeclaration
                blockStatements
                        .add(convertToVariableDeclarationStatement(
                                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)stmts[index]));
            }
        } else {
            // we can create a new FieldDeclaration
    ...
    protected void completeRecord(ArrayType arrayType,
                                  org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode astNode) {
    ...
    public ASTNode convert(boolean isInterface,
                           org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration methodDeclaration) {
        if (methodDeclaration instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AnnotationMethodDeclaration) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AnnotationMethodDeclaration)methodDeclaration);
        }
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference[] thrownExceptions =
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Argument[] parameters = methodDeclaration.arguments;
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall explicitConstructorCall = null;
        if (isConstructor) {
            if (isInterface) {
                // interface cannot have a constructor
                methodDecl.setFlags(methodDecl.getFlags() | ASTNode.MALFORMED);
            }
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ConstructorDeclaration constructorDeclaration =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ConstructorDeclaration)methodDeclaration;
        ...
        } else if (methodDeclaration instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MethodDeclaration) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MethodDeclaration method =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MethodDeclaration)methodDeclaration;
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeReference = method.returnType;
        ...
        if (closingPosition != -1) {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement[] statements = methodDeclaration.statements;
            ...
            if (block != null && (statements != null || explicitConstructorCall != null)) {
                if (explicitConstructorCall != null
                    && explicitConstructorCall.accessMode !=
                       org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall.ImplicitSuper) {
            ...
            if (block != null
                && (Modifier.isAbstract(methodDecl.getModifiers()) || Modifier.isNative(methodDecl.getModifiers()) || isInterface)) {
                methodDecl.setFlags(methodDecl.getFlags() | ASTNode.MALFORMED);
            }
        } else {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeParameter[] typeParameters =
    ...
    public ClassInstanceCreation convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AllocationExpression expression) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression[] arguments = expression.arguments;
        if (arguments != null) {
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AND_AND_Expression expression) {
        InfixExpression infixExpression = new InfixExpression(this.ast);
        infixExpression.setOperator(InfixExpression.Operator.CONDITIONAL_AND);
        if (this.resolveBindings) {
            this.recordNodes(infixExpression, expression);
        }
        final int expressionOperatorID =
                (expression.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
        if (expression.left instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression
            && ((expression.left.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)) {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression leftOperand = expression.left;
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression rightOperand = null;
            do {
                rightOperand = ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression)leftOperand).right;
                if ((((leftOperand.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                      org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID &&
                     ((leftOperand.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))
                    || ((rightOperand instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression &&
                         ((rightOperand.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                          org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID) &&
                        ((rightOperand.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        temp.setSourceRange(startPosition, extendedOperand.getStartPosition() + extendedOperand.getLength()
                                                           - startPosition);
                ...
                leftOperand = ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression)leftOperand).left;
            }
            while (leftOperand instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression
                   && ((leftOperand.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0));
    ...
    public ASTNode convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AnnotationMethodDeclaration annotationTypeMemberDeclaration) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeReference =
                annotationTypeMemberDeclaration.returnType;
        if (typeReference != null) {
            Type returnType = convertType(typeReference);
        ...
        annotationTypeMemberDeclaration2.setSourceRange(declarationSourceStart, declarationSourceEnd
                                                                                - declarationSourceStart + 1);
        // The javadoc comment is now got from list store in compilation unit declaration
        convert(annotationTypeMemberDeclaration.javadoc, annotationTypeMemberDeclaration2);
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression memberValue =
    ...
    public SingleVariableDeclaration convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Argument argument) {
    ...
    public Annotation convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation annotation) {
        if (annotation instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SingleMemberAnnotation) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SingleMemberAnnotation)annotation);
        } else if (annotation instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MarkerAnnotation) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MarkerAnnotation)annotation);
        } else {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.NormalAnnotation)annotation);
        }
    }

    public ArrayCreation convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayAllocationExpression expression) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression[] dimensions = expression.dimensions;
        ...
        if (type.isArrayType()) {
            ...
            for (int i = 0; i < dimensionsLength; i++) {
                previousSearchStart =
                        retrieveRightBracketPosition(previousSearchStart + 1, this.compilationUnitSourceLength);
    ...
    public ArrayInitializer convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayInitializer expression) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression[] expressions = expression.expressions;
        if (expressions != null) {
    ...
    public ArrayAccess convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayReference reference) {
    ...
    public AssertStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AssertStatement statement) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression exceptionArgument = statement.exceptionArgument;
    ...
    public Assignment convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Assignment expression) {
    ...
    public TypeDeclaration convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode[] nodes) {
        final TypeDeclaration typeDecl = new TypeDeclaration(this.ast);
        typeDecl.setInterface(false);
        int nodesLength = nodes.length;
        for (int i = 0; i < nodesLength; i++) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node = nodes[i];
            if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Initializer) {
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Initializer oldInitializer =
                        (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Initializer)node;
                Initializer initializer = new Initializer(this.ast);
                initializer.setBody(convert(oldInitializer.block));
                setModifiers(initializer, oldInitializer);
                initializer.setSourceRange(oldInitializer.declarationSourceStart, oldInitializer.sourceEnd
            ...
            } else if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration) {
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration =
                        (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration)node;
                if (i > 0
                    && (nodes[i - 1] instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration)
                    && ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration)nodes[i - 1]).declarationSourceStart ==
            ...
            } else if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration) {
                ...
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration =
                        (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration)node;
                AbstractTypeDeclaration nextMemberDeclarationNode = convert(nextMemberDeclaration);
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression expression) {
        InfixExpression infixExpression = new InfixExpression(this.ast);
        if (this.resolveBindings) {
            this.recordNodes(infixExpression, expression);
        }
        ...
        if (expression.left instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression
            ...
            final org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression[] stringLiterals = literal.literals;
    ...
    public Block convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Block statement) {
        Block block = new Block(this.ast);
        if (statement.sourceEnd > 0) {
            block.setSourceRange(statement.sourceStart, statement.sourceEnd - statement.sourceStart + 1);
        }
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement[] statements = statement.statements;
        if (statements != null) {
    ...
    public BreakStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BreakStatement statement) {
    ...
    public SwitchCase convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CaseStatement statement) {
        SwitchCase switchCase = new SwitchCase(this.ast);
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression constantExpression =
                statement.constantExpression;
    ...
    public CastExpression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CastExpression expression) {
    ...
    public CharacterLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CharLiteral expression) {
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ClassLiteralAccess expression) {
    ...
    public CompilationUnit convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CompilationUnitDeclaration unit, char[] source) {
        try {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ImportReference[] imports = unit.imports;
            if (imports != null) {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] types = unit.types;
            if (types != null) {
                int typesLength = types.length;
                for (int i = 0; i < typesLength; i++) {
                    org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration declaration = types[i];
                    if (CharOperation.equals(declaration.name, TypeConstants.PACKAGE_INFO_NAME)) {
                        continue;
                    }
                    AbstractTypeDeclaration type = convert(declaration);
                    if (type == null) {
            ...
            if (taskLenght != 0) {
                ...
                if (taskLenght == tasks.length) {
                    ...
                    System.arraycopy(tasks, 0, (resizedProblems = new CategorizedProblem[taskLenght]), 0, taskLenght);
                }
    ...
    public Assignment convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CompoundAssignment expression) {
        Assignment assignment = new Assignment(this.ast);
        Expression lhs = convert(expression.lhs);
        assignment.setLeftHandSide(lhs);
        int start = lhs.getStartPosition();
        ...
        switch (expression.operator) {
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.PLUS:
                assignment.setOperator(Assignment.Operator.PLUS_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.MINUS:
                assignment.setOperator(Assignment.Operator.MINUS_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.MULTIPLY:
                assignment.setOperator(Assignment.Operator.TIMES_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.DIVIDE:
                assignment.setOperator(Assignment.Operator.DIVIDE_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.AND:
                assignment.setOperator(Assignment.Operator.BIT_AND_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.OR:
                assignment.setOperator(Assignment.Operator.BIT_OR_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.XOR:
                assignment.setOperator(Assignment.Operator.BIT_XOR_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.REMAINDER:
                assignment.setOperator(Assignment.Operator.REMAINDER_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.LEFT_SHIFT:
                assignment.setOperator(Assignment.Operator.LEFT_SHIFT_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.RIGHT_SHIFT:
                assignment.setOperator(Assignment.Operator.RIGHT_SHIFT_SIGNED_ASSIGN);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.UNSIGNED_RIGHT_SHIFT:
    ...
    public ConditionalExpression convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ConditionalExpression expression) {
    ...
    public ContinueStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ContinueStatement statement) {
    ...
    public DoStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.DoStatement statement) {
    ...
    public NumberLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.DoubleLiteral expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
    ...
    public EmptyStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.EmptyStatement statement) {
    ...
    public EnumConstantDeclaration convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration enumConstant) {
        ...
        final org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression initialization =
                enumConstant.initialization;
        if (initialization != null) {
            if (initialization instanceof QualifiedAllocationExpression) {
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration anonymousType =
                ...
                enumConstantDeclaration.setSourceRange(declarationSourceStart, declarationSourceEnd
                                                                               - declarationSourceStart + 1);
            }
            final org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression[] arguments =
                    ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AllocationExpression)initialization).arguments;
            if (arguments != null) {
            ...
            enumConstantDeclaration.setSourceRange(declarationSourceStart, declarationSourceEnd - declarationSourceStart
                                                                           + 1);
        }
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.EqualExpression expression) {
        InfixExpression infixExpression = new InfixExpression(this.ast);
        if (this.resolveBindings) {
        ...
        int startPosition = leftExpression.getStartPosition();
        infixExpression.setSourceRange(startPosition, expression.sourceEnd - startPosition + 1);
        switch ((expression.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) {
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.EQUAL_EQUAL:
                infixExpression.setOperator(InfixExpression.Operator.EQUALS);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.NOT_EQUAL:
    ...
    public Statement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall statement) {
        ...
        if (statement.isSuperAccess() || statement.isSuper()) {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression[] arguments = statement.arguments;
            if (arguments != null) {
                int length = arguments.length;
                for (int i = 0; i < length; i++) {
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression expression) {
        if ((expression.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0) {
            return convertToParenthesizedExpression(expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CastExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CastExpression)expression);
        }
        // switch between all types of expression
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayAllocationExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayAllocationExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedAllocationExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedAllocationExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AllocationExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AllocationExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayInitializer) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayInitializer)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.PrefixExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.PrefixExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.PostfixExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.PostfixExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CompoundAssignment) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CompoundAssignment)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Assignment) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Assignment)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ClassLiteralAccess) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ClassLiteralAccess)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FalseLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FalseLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TrueLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TrueLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.NullLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.NullLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CharLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CharLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.DoubleLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.DoubleLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FloatLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FloatLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IntLiteralMinValue) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IntLiteralMinValue)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IntLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IntLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LongLiteralMinValue) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LongLiteralMinValue)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LongLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LongLiteral)expression);
        }
        if (expression instanceof StringLiteralConcatenation) {
            return convert((StringLiteralConcatenation)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ExtendedStringLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ExtendedStringLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.StringLiteral) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.StringLiteral)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AND_AND_Expression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AND_AND_Expression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OR_OR_Expression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OR_OR_Expression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.EqualExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.EqualExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.InstanceOfExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.InstanceOfExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.UnaryExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.UnaryExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ConditionalExpression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ConditionalExpression)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MessageSend) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MessageSend)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Reference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Reference)expression);
        }
        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference)expression);
        }
        return null;
    }

    public StringLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ExtendedStringLiteral expression) {
    ...
    public BooleanLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FalseLiteral expression) {
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldReference reference) {
        if (reference.receiver.isSuper()) {
            ...
            if (reference.receiver instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference) {
                Name qualifier =
                        convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference)reference.receiver);
            ...
            superFieldAccess.setSourceRange(reference.receiver.sourceStart, reference.sourceEnd
                                                                            - reference.receiver.sourceStart + 1);
    ...
    public NumberLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FloatLiteral expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
        NumberLiteral literal = new NumberLiteral(this.ast);
        literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
    ...
    public Statement convert(ForeachStatement statement) {
        switch (this.ast.apiLevel) {
            ...
            default:
                ...
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression collection = statement.collection;
                if (collection == null)
                    return null;
    ...
    public ForStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ForStatement statement) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement[] initializations = statement.initializations;
        if (initializations != null) {
            // we know that we have at least one initialization
            if (initializations[0] instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration) {
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration initialization =
                        (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)initializations[0];
                VariableDeclarationExpression variableDeclarationExpression =
                        convertToVariableDeclarationExpression(initialization);
                int initializationsLength = initializations.length;
                for (int i = 1; i < initializationsLength; i++) {
                    initialization =
                            (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)initializations[i];
                ...
                if (initializationsLength != 1) {
                    ...
                    int end =
                            ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)initializations[initializationsLength -
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement[] increments = statement.increments;
        if (increments != null) {
    ...
    public IfStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IfStatement statement) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement statement2 = statement.elseStatement;
        if (statement2 != null) {
    ...
    public InstanceofExpression convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.InstanceOfExpression expression) {
    ...
    public NumberLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IntLiteral expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
    ...
    public NumberLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IntLiteralMinValue expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
        NumberLiteral literal = new NumberLiteral(this.ast);
        literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
    ...
    public void convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Javadoc javadoc,
    ...
    public LabeledStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LabeledStatement statement) {
    ...
    public NumberLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LongLiteral expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
        final NumberLiteral literal = new NumberLiteral(this.ast);
        literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
    ...
    public NumberLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LongLiteralMinValue expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
        final NumberLiteral literal = new NumberLiteral(this.ast);
        literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
    ...
    public Expression convert(MessageSend expression) {
        ...
        if (expression.isSuperAccess()) {
            ...
            if (expression.receiver instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference) {
                Name qualifier =
                        convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference)expression.receiver);
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression receiver = expression.receiver;
            if (receiver instanceof MessageSend) {
                if ((receiver.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0) {
    ...
    public MarkerAnnotation convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MarkerAnnotation annotation) {
    ...
    public MemberValuePair convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MemberValuePair memberValuePair) {
    ...
    public Name convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.NameReference reference) {
        if (reference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedNameReference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedNameReference)reference);
        } else {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SingleNameReference)reference);
        }
    }
    ...
    public InfixExpression convert(StringLiteralConcatenation expression) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression[] stringLiterals = expression.literals;
        infixExpression.setLeftOperand(convert(stringLiterals[0]));
        infixExpression.setRightOperand(convert(stringLiterals[1]));
    ...
    public NormalAnnotation convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.NormalAnnotation annotation) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MemberValuePair[] memberValuePairs =
    ...
    public NullLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.NullLiteral expression) {
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OR_OR_Expression expression) {
        InfixExpression infixExpression = new InfixExpression(this.ast);
    ...
    public PostfixExpression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.PostfixExpression expression) {
    ...
    public PrefixExpression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.PrefixExpression expression) {
    ...
    public Expression convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedAllocationExpression allocation) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression[] arguments = allocation.arguments;
        if (arguments != null) {
            int length = arguments.length;
            for (int i = 0; i < length; i++) {
        ...
        if (allocation.anonymousType != null) {
            ...
            classInstanceCreation.setSourceRange(declarationSourceStart, allocation.anonymousType.bodyEnd
                                                                         - declarationSourceStart + 1);
    ...
    public Name convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedNameReference nameReference) {
        return setQualifiedNameNameAndSourceRanges(nameReference.tokens, nameReference.sourcePositions, nameReference);
    }

    public Name convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference reference) {
        return convert(reference.qualification);
    }

    public ThisExpression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedThisReference reference) {
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Reference reference) {
        if (reference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.NameReference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.NameReference)reference);
        }
        if (reference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ThisReference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ThisReference)reference);
        }
        if (reference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayReference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ArrayReference)reference);
        }
        if (reference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldReference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldReference)reference);
        }
        return null; // cannot be reached
    }

    public ReturnStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ReturnStatement statement) {
    ...
    public SingleMemberAnnotation convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SingleMemberAnnotation annotation) {
    ...
    public SimpleName convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SingleNameReference nameReference) {
        final SimpleName name = new SimpleName(this.ast);
    ...
    public Statement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement statement) {
        if (statement instanceof ForeachStatement) {
            return convert((ForeachStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration localDeclaration =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)statement;
            return convertToVariableDeclarationStatement(localDeclaration);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AssertStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.AssertStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Block) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Block)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BreakStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.BreakStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ContinueStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ContinueStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CaseStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CaseStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.DoStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.DoStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.EmptyStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.EmptyStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ForStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ForStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IfStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.IfStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LabeledStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.LabeledStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ReturnStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ReturnStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SwitchStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SwitchStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SynchronizedStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SynchronizedStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ThrowStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ThrowStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TryStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TryStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration) {
            ASTNode result = convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration)statement);
            if (result == null) {
                return createFakeEmptyStatement(statement);
            }
        ...
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.WhileStatement) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.WhileStatement)statement);
        }
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression statement2 =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression)statement;
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.StringLiteral expression) {
        if (expression instanceof StringLiteralConcatenation) {
            return convert((StringLiteralConcatenation)expression);
        }
        int length = expression.sourceEnd - expression.sourceStart + 1;
    ...
    public SwitchStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SwitchStatement statement) {
    ...
    public SynchronizedStatement convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SynchronizedStatement statement) {
    ...
    public Expression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ThisReference reference) {
        if (reference.isImplicitThis()) {
            // There is no source associated with an implicit this
            return null;
        } else if (reference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference)reference);
        } else if (reference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedThisReference) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedThisReference)reference);
        } else {
    ...
    public ThrowStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ThrowStatement statement) {
    ...
    public BooleanLiteral convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TrueLiteral expression) {
        final BooleanLiteral literal = new BooleanLiteral(this.ast);
    ...
    public TryStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TryStatement statement) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Argument[] catchArguments = statement.catchArguments;
        if (catchArguments != null) {
            int catchArgumentsLength = catchArguments.length;
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Block[] catchBlocks = statement.catchBlocks;
    ...
    public AbstractTypeDeclaration convert(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
        int kind = org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration.kind(typeDeclaration.modifiers);
        switch (kind) {
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration.ENUM_DECL:
                if (this.ast.apiLevel == AST.JLS2_INTERNAL) {
                    return null;
                } else {
                    return convertToEnumDeclaration(typeDeclaration);
                }
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration.ANNOTATION_TYPE_DECL:
                if (this.ast.apiLevel == AST.JLS2_INTERNAL) {
                    return null;
                } else {
        ...
        boolean isInterface =
                kind == org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration.INTERFACE_DECL;
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference[] superInterfaces =
    ...
    public TypeParameter convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeParameter typeParameter) {
    ...
    public Name convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeReference) {
        char[][] typeName = typeReference.getTypeName();
        int length = typeName.length;
        if (length > 1) {
            // QualifiedName
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference qualifiedTypeReference =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference;
    ...
    public PrefixExpression convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.UnaryExpression expression) {
        final PrefixExpression prefixExpression = new PrefixExpression(this.ast);
        if (this.resolveBindings) {
        ...
        switch ((expression.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
            ...
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.MINUS:
                ...
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.NOT:
                prefixExpression.setOperator(PrefixExpression.Operator.NOT);
                break;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.TWIDDLE:
                prefixExpression.setOperator(PrefixExpression.Operator.COMPLEMENT);
        }
        return prefixExpression;
    }

    public WhileStatement convert(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.WhileStatement statement) {
    ...
    public ImportDeclaration convertImport(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ImportReference importReference) {
        final ImportDeclaration importDeclaration = new ImportDeclaration(this.ast);
        final boolean onDemand =
                (importReference.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0;
        ...
        importDeclaration.setSourceRange(importReference.declarationSourceStart, importReference.declarationEnd
    ...
    public PackageDeclaration convertPackage(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.CompilationUnitDeclaration compilationUnitDeclaration) {
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ImportReference importReference =
        ...
        packageDeclaration.setSourceRange(importReference.declarationSourceStart, importReference.declarationEnd
                                                                                  - importReference.declarationSourceStart + 1);
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation[] annotations = importReference.annotations;
        if (annotations != null) {
            switch (this.ast.apiLevel) {
                case AST.JLS2_INTERNAL:
    ...
    private EnumDeclaration convertToEnumDeclaration(
        ...
        enumDeclaration2.setSourceRange(typeDeclaration.declarationSourceStart, typeDeclaration.bodyEnd
                                                                                - typeDeclaration.declarationSourceStart + 1);
    ...
    public Expression convertToExpression(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement statement) {
        if (statement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression) {
            return convert((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression)statement);
        } else {
            return null;
        }
    }
    ...
    protected FieldDeclaration convertToFieldDeclaration(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration fieldDecl) {
    ...
    public ParenthesizedExpression convertToParenthesizedExpression(
        ...
        int numberOfParenthesis =
                (expression.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) >>
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
        expression.bits &= ~org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK;
        expression.bits |=
                (numberOfParenthesis - 1) << org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
    ...
    protected VariableDeclarationFragment convertToVariableDeclarationFragment(
        ...
        int end = start;
        int extraDimensions =
                retrieveExtraDimension(fieldDeclaration.sourceEnd + 1, fieldDeclaration.declarationSourceEnd);
        ...
        if (fieldDeclaration.initialization != null) {
            ...
            int possibleEnd =
                    retrieveEndOfPotentialExtendedDimensions(start + 1, fieldDeclaration.sourceEnd,
    ...
    protected VariableDeclarationFragment convertToVariableDeclarationFragment(
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression initialization = localDeclaration.initialization;
        ...
        if (hasInitialization) {
            ...
            int possibleEnd =
                    retrieveEndOfPotentialExtendedDimensions(start + 1, localDeclaration.sourceEnd,
    ...
    public Type convertType(TypeReference typeReference) {
        ...
        if (typeReference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SingleTypeReference) {
            // this is either an ArrayTypeReference or a SingleTypeReference
            char[] name =
                    ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.SingleTypeReference)typeReference).getTypeName()[0];
            ...
            if (typeReference instanceof ParameterizedQualifiedTypeReference) {
            ...
            } else if (typeReference instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference) {
                char[][] name =
                        ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference)
                                .getTypeName();
                int nameLength = name.length;
                long[] positions =
                        ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference).sourcePositions;
                sourceStart = (int)(positions[0] >>> 32);
                length = (int)(positions[nameLength - 1] & 0xFFFFFFFF) - sourceStart + 1;
                ...
                TypeReference[] typeReferences =
                        ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.UnionTypeReference)typeReference).typeReferences;
                switch (this.ast.apiLevel) {
                    case AST.JLS2_INTERNAL:
                    case AST.JLS3:
                        // recovery
    ...
    protected Statement createFakeEmptyStatement(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Statement statement) {
        if (statement == null)
            return null;
        EmptyStatement emptyStatement = new EmptyStatement(this.ast);
    ...
    protected InfixExpression.Operator getOperatorFor(int operatorID) {
        switch (operatorID) {
            ...
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.LESS_EQUAL:
                return InfixExpression.Operator.LESS_EQUALS;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.GREATER_EQUAL:
            ...
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.OR_OR:
                return InfixExpression.Operator.CONDITIONAL_OR;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.AND_AND:
            ...
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.GREATER:
                return InfixExpression.Operator.GREATER;
            case org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.LESS:
    ...
    private BlockScope lookupScope(ASTNode node) {
        ...
        if (currentNode instanceof Initializer) {
            ...
            if (currentNode instanceof TypeDeclaration || currentNode instanceof EnumDeclaration
                ...
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration typeDecl =
                        (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration)this.ast.getBindingResolver()
    ...
    protected void recordName(Name name, org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode compilerNode) {
        if (compilerNode != null) {
            recordNodes(name, compilerNode);
            if (compilerNode instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference) {
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeRef =
                        (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference)compilerNode;
    ...
    protected void recordNodes(ASTNode node, org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode oldASTNode) {
        this.ast.getBindingResolver().store(node, oldASTNode);
    }

    protected void recordNodes(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Javadoc javadoc,
        ...
        while (fragments.hasNext()) {
            ...
            if (node.getNodeType() == ASTNode.MEMBER_REF) {
                ...
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode compilerNode =
                ...
                if (memberRef.getQualifier() != null) {
                    org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeRef = null;
                    if (compilerNode instanceof JavadocFieldReference) {
                        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression expression =
                                ((JavadocFieldReference)compilerNode).receiver;
                        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference) {
                            typeRef = (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference)expression;
                        }
                ...
                if (compilerNode != null) {
                    ...
                    // get type ref
                    org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeRef = null;
                    if (compilerNode instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocAllocationExpression) {
                        typeRef =
                                ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocAllocationExpression)compilerNode).type;
                        if (typeRef != null)
                            recordNodes(name, compilerNode);
                    } else if (compilerNode instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocMessageSend) {
                        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression expression =
                                ((org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocMessageSend)compilerNode).receiver;
                        if (expression instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference) {
                            typeRef = (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeReference)expression;
                        }
                        recordNodes(name, compilerNode);
                ...
                while (parameters.hasNext()) {
                    ...
                    org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression expression =
                            (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression)javadoc.getNodeStartingAt(param
    ...
    private void trimWhiteSpacesAndComments(org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression expression) {
        int start = expression.sourceStart;
        int end = expression.sourceEnd;
        int token;
     ...
     *
     * @param initializerEnd
     *         the given initializer end exclusive
     * @return int the position found.
     */
    ...
    protected void setModifiers(BodyDeclaration bodyDeclaration,
                                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation[] annotations, int modifiersEnd) {
                ...
                switch (token) {
                    ...
                    case TerminalTokens.TokenNameAT:
                        ...
                        if (annotations != null && indexInAnnotations < annotations.length) {
                            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation annotation =
    ...
    protected void setModifiers(EnumConstantDeclaration enumConstantDeclaration,
        ...
        switch (this.ast.apiLevel) {
            case AST.JLS2_INTERNAL:
                enumConstantDeclaration.internalSetModifiers(fieldDeclaration.modifiers
    ...
    protected void setModifiers(SingleVariableDeclaration variableDecl, Argument argument) {
        switch (this.ast.apiLevel) {
            ...
            default:
                ...
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation[] annotations = argument.annotations;
                int indexInAnnotations = 0;
                try {
                    int token;
                    while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF) {
    ...
    protected void setModifiers(SingleVariableDeclaration variableDecl, LocalDeclaration localDeclaration) {
        switch (this.ast.apiLevel) {
            ...
            default:
                ...
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation[] annotations =
    ...
    protected QualifiedName setQualifiedNameNameAndSourceRanges(char[][] typeName, long[] positions,
                                                                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node) {
        int length = typeName.length;
    ...
    protected void setTypeNameForAnnotation(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation compilerAnnotation, Annotation annotation) {
