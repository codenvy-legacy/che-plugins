...
public class RecoveredMethod extends RecoveredElement implements TerminalTokens {
    ...
    public RecoveredElement add(TypeDeclaration typeDeclaration, int bracketBalanceValue) {
       ...
       */
        ...
        if ((typeDeclaration.bits & ASTNode.IsLocalType) != 0 || parser().methodRecoveryActivated
             ...
             */
                if (this.methodDeclaration.isConstructor()) {
                    ...
                    if (this.methodDeclaration.statements != null
                        ...
                        System.arraycopy(this.methodDeclaration.statements, 1, (this.methodDeclaration.statements =
                                new Statement[length - 1]), 0, length - 1);
                    }
                ...
                */
                   ...
                   */
                    ...
                    while (argLength > 0 && parser.astStack[parser.astPtr] instanceof MemberValuePair) {
                        System.arraycopy(parser.astStack, argStart, memberValuePairs = new MemberValuePair[argLength], 0,
                                         argLength);
                        parser.astLengthPtr--;
                    ...
                    for (count = 0; count < argLength; count++) {
                     ...
                     /* cannot be an argument if non final */
                            ...
                            if ((argument.modifiers & ~ClassFileConstants.AccFinal) != 0
                                || (argTypeName.length == 1 && CharOperation.equals(argTypeName[0],
                                                                                    TypeBinding.VOID.sourceName()))) {
                    ...
                    if (parser.listLength > 0 && parser.astLengthPtr > 0) {
                      ...
                      */
                            if (parser.currentElement ==
                                this) { // parameter addition might have added an awaiting (no return type) method - see 1FVXQZ4 */
                                this.methodDeclaration.sourceEnd =
                                        this.methodDeclaration.arguments[this.methodDeclaration.arguments.length - 1].sourceEnd;
    ...
    void attach(TypeParameter[] parameters, int startPos) {
        ...
        if (Util.getLineNumber(this.methodDeclaration.declarationSourceStart, scanner.lineEnds, 0, scanner.linePtr) != Util
                .getLineNumber(lastParameterEnd, scanner.lineEnds, 0, scanner.linePtr))
            return;
