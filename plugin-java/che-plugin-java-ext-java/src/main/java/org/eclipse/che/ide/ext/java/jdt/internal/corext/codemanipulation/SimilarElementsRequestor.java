...
import org.eclipse.che.ide.ext.java.jdt.compiler.batch.CompilationUnit;
...
import org.eclipse.che.ide.ext.java.jdt.internal.text.correction.NameMatcher;
...
public class SimilarElementsRequestor extends CompletionRequestor {
    ...
    public static SimilarElement[] findSimilarElement(Document document,
                                                      org.eclipse.che.ide.ext.java.jdt.core.dom.CompilationUnit compilationUnit, Name name,
                                                      int kind) {
    ...
    private SimilarElement[] process(int pos, Document document,
                                     org.eclipse.che.ide.ext.java.jdt.core.dom.CompilationUnit compilationUnit) {
        try {
