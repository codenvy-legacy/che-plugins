...
public class WhileStatement extends Statement {
     ...
     * @since 3.0
     */
    public static final ChildPropertyDescriptor EXPRESSION_PROPERTY = new ChildPropertyDescriptor(WhileStatement.class,
    ...
    /**
     * Creates a new unparented while statement node owned by the given AST. By default, the expresssion is unspecified, but legal,
     ...
     * <p>
     * Special note: The Java language does not allow a local variable declaration to appear as the body of a while statement (they
     * may only appear within a block). However, the AST will allow a <code>VariableDeclarationStatement</code> as the body of a
     * <code>WhileStatement</code>. To get something that will compile, be sure to embed the
