...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocAllocationExpression;
...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.JavadocSingleNameReference;
...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ElementValuePair;
...
public class DefaultBindingResolver extends BindingResolver {
    ...
    IBinding getBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.Binding binding) {
        switch (binding.kind()) {
            case Binding.PACKAGE:
                return getPackageBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding)binding);
            case Binding.TYPE:
            case Binding.BASE_TYPE:
            case Binding.GENERIC_TYPE:
            case Binding.PARAMETERIZED_TYPE:
            case Binding.RAW_TYPE:
                return getTypeBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)binding);
            case Binding.ARRAY_TYPE:
            case Binding.TYPE_PARAMETER:
                return new TypeBinding(this, (org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)binding);
            case Binding.METHOD:
                return getMethodBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding)binding);
            case Binding.FIELD:
            case Binding.LOCAL:
                return getVariableBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.VariableBinding)binding);
        }
        return null;
    }

    synchronized org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
        return (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(currentNode);
    }

    /* Method declared on BindingResolver. */
    synchronized IMethodBinding getMethodBinding(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding methodBinding) {
        if (methodBinding != null && !methodBinding.isValidBinding()) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ProblemMethodBinding)methodBinding;
    ...
    synchronized IPackageBinding getPackageBinding(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding packageBinding) {
    ...
    /* Method declared on BindingResolver. */
    public ITypeBinding getTypeBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding referenceBinding) {
            ...
            switch (referenceBinding.problemId()) {
                ...
                case ProblemReasons.NonStaticReferenceInStaticContext:
                    if (referenceBinding instanceof ProblemReferenceBinding) {
                        ...
                        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding binding2 =
    ...
    synchronized IVariableBinding getVariableBinding(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.VariableBinding variableBinding,
    ...
    synchronized IVariableBinding getVariableBinding(
        ...
        if (variableBinding != null) {
            if (variableBinding.isValidBinding()) {
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding variableType = variableBinding.type;
    ...
    synchronized IAnnotationBinding getAnnotationInstance(
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding internalInstance) {
    ...
    boolean isResolvedTypeInferredFromExpectedType(MethodInvocation methodInvocation) {
        ...
        if (oldNode instanceof MessageSend) {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding methodBinding = messageSend.binding;
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.core.dom.BindingResolver#recordScope(ASTNode, BlockScope) */
    ...
    boolean resolveBoxing(Expression expression) {
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node =
                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
        if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression compilerExpression =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression)node;
    ...
    synchronized IMethodBinding resolveConstructor(ClassInstanceCreation expression) {
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node =
                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
        if (node != null && (node.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration =
    ...
    IMethodBinding resolveConstructor(EnumConstantDeclaration enumConstantDeclaration) {
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node =
                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(enumConstantDeclaration);
        if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration) {
            ...
            switch (expression.getNodeType()) {
                case ASTNode.CLASS_INSTANCE_CREATION:
                    org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode astNode =
                            (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
                    if (astNode instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration) {
                        // anonymous type case
                        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration =
                                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration)astNode;
                ...
                case ASTNode.SINGLE_MEMBER_ANNOTATION:
                    org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression compilerExpression =
                            (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression)this.newAstToOldAst.get(expression);
    ...
    synchronized IBinding resolveImport(ImportDeclaration importDeclaration) {
        ...
        try {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(importDeclaration);
            if (node instanceof ImportReference) {
                ImportReference importReference = (ImportReference)node;
                final boolean isStatic = importReference.isStatic();
                if ((importReference.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0) {
                    Binding binding =
                            this.scope.getImport(
                                    CharOperation.subarray(importReference.tokens, 0, importReference.tokens.length), true, isStatic);
                    if (binding != null) {
                        if (isStatic) {
                            if (binding instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding) {
                                ITypeBinding typeBinding =
                                        this.getTypeBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)binding);
                                return typeBinding == null ? null : typeBinding;
                            }
                        } else {
                            if ((binding.kind() & Binding.PACKAGE) != 0) {
                                IPackageBinding packageBinding =
                                        getPackageBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding)binding);
                                if (packageBinding == null) {
                                    return null;
                                }
                    ...
                    if (binding != null) {
                        if (isStatic) {
                            ...
                            } else if (binding instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding) {
                                // it is a type
                                return getMethodBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding)binding);
                            }
                        } else {
    ...
    synchronized ITypeBinding resolveTypeBindingForName(Name name) {
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node =
                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(name);
        ...
        if (node instanceof QualifiedNameReference) {
            ...
            if (index < indexOfFirstFieldBinding) {
                ...
                if (binding instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding) {
                    return null;
                } else if (binding instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding) {
                    // it is a type
                    return this.getTypeBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)binding);
                }
                ...
                if (qualifiedNameReference.isTypeReference()) {
                    ...
                    if (fieldBinding == null)
                        return null;
                    org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding type = fieldBinding.declaringClass;
                    if (type == null) { // array length scenario
                        ...
                        switch (qualifiedNameReference.bits
                                & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.RestrictiveFlagMASK) {
                            case Binding.FIELD:
                        ...
                        binding =
                                this.scope.getImport(CharOperation.subarray(importReference.tokens, 0, index),
                                                     (importReference.bits &
                                                      org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0,
        ...
        if (node instanceof SingleNameReference) {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding binding = singleTypeReference.resolvedType;
            if (binding != null) {
        ...
        } else if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeParameter) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeParameter typeParameter =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeParameter)node;
            return this.getTypeBinding(typeParameter.binding);
        } else if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MemberValuePair) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MemberValuePair memberValuePair =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.MemberValuePair)node;
    ...
    synchronized IBinding resolveName(Name name) {
        ...
        if (node instanceof QualifiedNameReference) {
                ...
                if (qualifiedNameReference.isTypeReference()) {
                    ...
                    if (binding != null) {
                        if (binding.isValidBinding()) {
                            return this
                                    .getVariableBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.VariableBinding)binding);
            ...
            if (index >= 0) {
                ...
                if (binding != null) {
                    if (binding instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding) {
                        ...
                        // it is a type
                        return this.getTypeBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)binding);
                    } else if (binding instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.FieldBinding) {
                        // it is a type
                        return this.getVariableBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.FieldBinding)binding);
                    } else if (binding instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding) {
                        // it is a type
                        return getMethodBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding)binding);
                    } else {
            ...
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] types = compilationUnitDeclaration.types;
            if (types == null || types.length == 0) {
                return null;
            }
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration type = types[0];
            if (type != null) {
    ...
    synchronized IPackageBinding resolvePackage(PackageDeclaration pkg) {
        ...
        try {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(pkg);
            if (node instanceof ImportReference) {
                ImportReference importReference = (ImportReference)node;
                Binding binding =
    ...
    synchronized IBinding resolveReference(MemberRef ref) {
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression expression =
                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Expression)this.newAstToOldAst.get(ref);
    ...
    synchronized IMemberValuePairBinding resolveMemberValuePair(
            org.eclipse.che.ide.ext.java.jdt.core.dom.MemberValuePair memberValuePair) {
    ...
    ITypeBinding resolveType(AnnotationTypeDeclaration type) {
        ...
        if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration)node;
            ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
            if (typeBinding == null) {
    ...
    synchronized ITypeBinding resolveType(AnonymousClassDeclaration type) {
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node =
                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(type);
        if (node != null && (node.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration)node;
    ...
    synchronized ITypeBinding resolveType(Type type) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode node =
                (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(type);
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding binding = null;
        if (node != null) {
            if (node instanceof ParameterizedQualifiedTypeReference) {
                ...
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding typeBinding = typeReference.resolvedType;
                if (type.isArrayType()) {
                    if (this.scope == null) {
                        return null;
                    }
          ...
          */
            if (((PrimitiveType)type).getPrimitiveTypeCode() == PrimitiveType.VOID) {
                return this.getTypeBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.VOID);
            }
        }
        return null;
    }
    ...
    synchronized ITypeBinding resolveTypeParameter(TypeParameter typeParameter) {
        ...
        if (node instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeParameter) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeParameter typeParameter2 =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.TypeParameter)node;
    ...
    synchronized IVariableBinding resolveVariable(VariableDeclaration variable) {
        ...
        if (node instanceof AbstractVariableDeclaration) {
            ...
            if (abstractVariableDeclaration instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration) {
                org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration =
                        (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration)abstractVariableDeclaration;
    ...
    synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode) {
        ...
        if (oldNode instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation) {
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation internalAstNode =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.Annotation)oldNode;
    ...
    /* Method declared on BindingResolver. */
    synchronized void store(ASTNode node, org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode oldASTNode) {
    ...
    ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding leafTypeBinding = null;
        if (leafComponentType.isPrimitive()) {
            String name = leafComponentType.getBinaryName();
            switch (name.charAt(0)) {
                case 'I':
                    leafTypeBinding = org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.INT;
                    break;
                case 'B':
                    leafTypeBinding = org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.BYTE;
                    break;
                case 'Z':
                    leafTypeBinding = org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.BOOLEAN;
                    break;
                case 'C':
                    leafTypeBinding = org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.CHAR;
                    break;
                case 'J':
                    leafTypeBinding = org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.LONG;
                    break;
                case 'S':
                    leafTypeBinding = org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.SHORT;
                    break;
                case 'D':
                    leafTypeBinding = org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.DOUBLE;
                    break;
                case 'F':
                    leafTypeBinding = org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding.FLOAT;
                    break;
                case 'V':
