...
import org.eclipse.che.ide.ext.java.jdt.core.util.ModifierConstants;
...
class VariableBinding implements IVariableBinding {
    ...
    private org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.VariableBinding binding;
    ...
    VariableBinding(BindingResolver resolver, org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.VariableBinding binding) {
    ...
    public int getModifiers() {
        ...
        if (this.binding.isFinal()) {
            return ModifierConstants.ACC_FINAL;
        }
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.VariableBinding otherBinding = ((VariableBinding)other).binding;
