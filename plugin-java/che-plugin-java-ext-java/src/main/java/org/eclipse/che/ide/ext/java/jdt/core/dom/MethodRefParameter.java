...
public class MethodRefParameter extends ASTNode {
    ...
    public static final SimplePropertyDescriptor VARARGS_PROPERTY = new SimplePropertyDescriptor(
            MethodRefParameter.class, "varargs", boolean.class, MANDATORY); //$NON-NLS-1$
    ...
    public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(MethodRefParameter.class,
                                                                                            "name", SimpleName.class, OPTIONAL,
     ...
     *
     * @param variableArity
     *         <code>true</code> if this is a variable arity parameter, and <code>false</code> otherwise
     * @since 3.1
     */
     ...
     *
     * @param name
     *         the parameter name node, or <code>null</code> if there is none
     * @throws IllegalArgumentException
     *         if:
     *         <ul>
     *         <li>the node belongs to a different AST</li>
