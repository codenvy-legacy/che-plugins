 ...
 * </p>
 * <p>
 * For a complete description of the configurable options, see {@link JavaCore#getDefaultOptions()}. To programmatically change
 * these options, see {@link JavaCore#setOptions(java.util.Hashtable)}.
 * </p>
 * <p>
...
public final class NamingConventions {
    static class NamingRequestor implements INamingRequestor {
        ...
        public void acceptNameWithPrefix(char[] name, boolean isFirstPrefix, int reusedCharacters) {
            if (isFirstPrefix) {
                ...
                if (length == this.firstPrefixResultsCount) {
                    System
                            .arraycopy(this.firstPrefixResults, 0, this.firstPrefixResults = new char[length * 2][], 0, length);
                }
        ...
        public void acceptNameWithPrefixAndSuffix(char[] name, boolean isFirstPrefix, boolean isFirstSuffix,
            ...
            if (isFirstPrefix && isFirstSuffix) {
                ...
                if (length == this.firstPrefixAndFirstSuffixResultsCount) {
                    System.arraycopy(this.firstPrefixAndFirstSuffixResults, 0, this.firstPrefixAndFirstSuffixResults =
                ...
                if (length == this.firstPrefixAndSuffixResultsCount) {
                    System.arraycopy(this.firstPrefixAndSuffixResults, 0, this.firstPrefixAndSuffixResults =
                            new char[length * 2][], 0, length);
                }
                ...
                if (length == this.prefixAndFirstSuffixResultsCount) {
                    System.arraycopy(this.prefixAndFirstSuffixResults, 0, this.prefixAndFirstSuffixResults =
                            new char[length * 2][], 0, length);
                }
                ...
                if (length == this.prefixAndSuffixResultsCount) {
                    System.arraycopy(this.prefixAndSuffixResults, 0, this.prefixAndSuffixResults = new char[length * 2][],
                                     0, length);
                }
        ...
        public void acceptNameWithSuffix(char[] name, boolean isFirstSuffix, int reusedCharacters) {
            if (isFirstSuffix) {
                ...
                if (length == this.firstSuffixResultsCount) {
                    System
                            .arraycopy(this.firstSuffixResults, 0, this.firstSuffixResults = new char[length * 2][], 0, length);
                }
        ...
        public char[][] getResults() {
            int count =
                    this.firstPrefixAndFirstSuffixResultsCount + this.firstPrefixAndSuffixResultsCount
    ...
    /**
     * The base name associated to this base name kind is a simple type name. When this base name is used all the words of the name
     * are considered.
     *
     * @see #suggestVariableNames(int, int, String, IJavaProject, int, String[], boolean)
     * @since 3.5
     ...
     * <p>
     * e.g.<br>
     * If the variable is a {@link #VK_LOCAL} and the variable name is <code>variableName</code> then the base name will be
     * <code>variableName</code>.<br>
     * If the variable is a {@link #VK_STATIC_FINAL_FIELD} and the variable name is <code>VARIABLE_NAME</code> then the base name
     * will be <code>variableName</code>.<br>
     * </p>
     * <p>
     ...
     * <p>
     * e.g.<br>
     * If the variable is a {@link #VK_LOCAL}, the variable name is <code>preVariableNamesuf</code>, a possible prefix is
     * <code>pre</code> and a possible suffix is <code>suf</code> then the base name will be <code>variableName</code>.<br>
     * </p>
     *
     * @param variableKind
     *         specifies what type the variable is: {@link #VK_LOCAL}, {@link #VK_PARAMETER}, {@link #VK_STATIC_FIELD},
     *         {@link #VK_INSTANCE_FIELD} or {@link #VK_STATIC_FINAL_FIELD}.
     * @param variableName
     *         a variable name
     * @param javaProject
     *         project which contains the variable or <code>null</code> to take into account only workspace settings.
     * @see #suggestVariableNames(int, int, String, IJavaProject, int, String[], boolean)
     * @since 3.5
     */
    public static String getBaseName(int variableKind, String variableName) {
        return String.valueOf(InternalNamingConventions.getBaseName(variableKind, variableName.toCharArray(), true));
    }
    ...
    private static char[] suggestAccessorName(char[] fieldName, int modifiers) {
        char[] name = InternalNamingConventions.getBaseName(getFieldVariableKind(modifiers), fieldName, false);
    ...
    // * @see JavaCore#getDefaultOptions()
    // *
    // * @deprecated Use {@link #suggestVariableNames(int, int, String, IJavaProject, int, String[], boolean)} instead with {@link
    // #VK_PARAMETER} as variable kind.
    // */
    // public static char[][] suggestArgumentNames(IJavaProject javaProject, char[] packageName, char[] qualifiedTypeName, int dim,
    // char[][] excludedNames) {
    ...
    // #VK_PARAMETER} as variable kind.
    // */
    // public static String[] suggestArgumentNames(IJavaProject javaProject, String packageName, String qualifiedTypeName, int dim,
    ...
    // * with {@link #VK_INSTANCE_FIELD} or {@link #VK_STATIC_FIELD} as variable kind.
    // */
    // public static char[][] suggestFieldNames(IJavaProject javaProject, char[] packageName, char[] qualifiedTypeName, int dim,
    ...
    // * with {@link #VK_INSTANCE_FIELD} or {@link #VK_STATIC_FIELD} as variable kind.
    // */
    // public static String[] suggestFieldNames(IJavaProject javaProject, String packageName, String qualifiedTypeName, int dim,
     ...
     * <p>
     * If the field name is <code>preFieldNamesuf</code> and the prefix for field is <code>pre</code> and the suffix for field is
     * <code>suf</code> then the prosposed name is <code>isFieldName</code> for boolean field or <code>getFieldName</code> for
     * others. If there is no prefix and suffix the proposal is <code>isPreFieldNamesuf</code> for boolean field or
     * <code>getPreFieldNamesuf</code> for others.
     * </p>
     * <p>
     * This method is affected by the following JavaCore options : {@link JavaCore#CODEASSIST_FIELD_PREFIXES},
     * {@link JavaCore#CODEASSIST_FIELD_SUFFIXES} for instance field and {@link JavaCore#CODEASSIST_STATIC_FIELD_PREFIXES},
     ...
     * </p>
     * <p>
     * For a complete description of these configurable options, see <code>getDefaultOptions</code>. For programmaticaly change
     * these options, see <code>JavaCore#setOptions()</code>.
     * </p>
     *
     * @param project
     ...
     *         field's name's.
     * @param modifiers
     *         field's modifiers as defined by the class <code>Flags</code>.
     * @param isBoolean
     *         <code>true</code> if the field's type is boolean
     * @param excludedNames
     *         a list of names which cannot be suggested (already used names). Can be <code>null</code> if there is no
     *         excluded names.
     * @return char[] a name.
     * @see Flags
     * @see JavaCore#setOptions(java.util.Hashtable)
     * @see JavaCore#getDefaultOptions()
     */
    public static char[] suggestGetterName(char[] fieldName, int modifiers, boolean isBoolean, char[][] excludedNames) {
        if (isBoolean) {
            char[] name = InternalNamingConventions.getBaseName(getFieldVariableKind(modifiers), fieldName, false);
            ...
            if (CharOperation.prefixEquals(GETTER_BOOL_NAME, name) && name.length > prefixLen
                ...
                return suggestNewName(CharOperation.concat(GETTER_BOOL_NAME, suggestAccessorName(fieldName, modifiers)),
                                      excludedNames);
            }
        } else {
            return suggestNewName(CharOperation.concat(GETTER_NAME, suggestAccessorName(fieldName, modifiers)),
                                  excludedNames);
        }
    }
     ...
     * @see JavaCore#getDefaultOptions()
     */
    public static String suggestGetterName(String fieldName, int modifiers, boolean isBoolean, String[] excludedNames) {
        return String.valueOf(suggestGetterName(fieldName.toCharArray(), modifiers, isBoolean,
                                                convertStringToChars(excludedNames)));
    }
    ...
    // *
    // * @deprecated Use {@link #suggestVariableNames(int, int, String, IJavaProject, int, String[], boolean)} instead with {@link
    // #VK_LOCAL} as variable kind.
    // */
    // public static char[][] suggestLocalVariableNames(IJavaProject javaProject, char[] packageName, char[] qualifiedTypeName, int
    // dim, char[][] excludedNames) {
    // if(qualifiedTypeName == null || qualifiedTypeName.length == 0)
    // return CharOperation.NO_CHAR_CHAR;
    //
    // char[] typeName = CharOperation.lastSegment(qualifiedTypeName, '.');
    ...
    // #VK_LOCAL} as variable kind.
    // */
    // public static String[] suggestLocalVariableNames(IJavaProject javaProject, String packageName, String qualifiedTypeName, int
    // dim, String[] excludedNames) {
    // return convertCharsToString(
     ...
     * <p>
     * If the field name is <code>preFieldNamesuf</code> and the prefix for field is <code>pre</code> and the suffix for field is
     * <code>suf</code> then the proposed name is <code>setFieldName</code>. If there is no prefix and suffix the proposal is
     * <code>setPreFieldNamesuf</code>.
     * </p>
     * <p>
     * This method is affected by the following JavaCore options : {@link JavaCore#CODEASSIST_FIELD_PREFIXES},
     * {@link JavaCore#CODEASSIST_FIELD_SUFFIXES} for instance field and {@link JavaCore#CODEASSIST_STATIC_FIELD_PREFIXES},
     ...
     * @see JavaCore#getDefaultOptions()
     */
    public static char[] suggestSetterName(char[] fieldName, int modifiers, boolean isBoolean, char[][] excludedNames) {
        ...
        if (isBoolean) {
            ...
            if (CharOperation.prefixEquals(GETTER_BOOL_NAME, name) && name.length > prefixLen
                ...
                return suggestNewName(CharOperation.concat(SETTER_NAME, suggestAccessorName(name, modifiers)),
                                      excludedNames);
            } else {
                return suggestNewName(CharOperation.concat(SETTER_NAME, suggestAccessorName(fieldName, modifiers)),
                                      excludedNames);
            }
        } else {
            return suggestNewName(CharOperation.concat(SETTER_NAME, suggestAccessorName(fieldName, modifiers)),
     ...
     * @see JavaCore#getDefaultOptions()
     */
    public static String suggestSetterName(String fieldName, int modifiers, boolean isBoolean, String[] excludedNames) {
        return String.valueOf(suggestSetterName(fieldName.toCharArray(), modifiers, isBoolean,
                                                convertStringToChars(excludedNames)));
    }
     ...
     * <p/>
     * <p>
     * The base name is used to compute the variable name. Some different kinds of base names are possible and each kind is
     * associated to a different heuristic to compute variable names.<br>
     * The heuristic depends also on the kind of the variable. Each kind of variable is identified by a constant starting with
     * <code>VK_</code>.<br>
     * When a prefix and a suffix can be added then all combinations of prefix and suffix are suggested. If the name is
     * <code>name</code>, the prefix is <code>pre</code> and the suffix is <code>suf</code> then the suggested names will be
     * <code>prenamesuf</code>, <code>prename</code>, <code>namesuf</code> and <code>name</code>.<br>
     * <br>
     * The different kinds of base names are:
     * <ul>
     * <li>{@link #BK_NAME}: the base name is a Java name and the whole base name is considered to compute the variable names. A
     * prefix and a suffix can be added.<br>
     ...
     * If the base name is <code>SimpleName</code> then the suggested name will be <code>simpleName</code>.<br>
     * </li>
     ...
     * </ul>
     * </li>
     * <li>{@link #BK_TYPE_NAME}: the base name is a Java simple type name (e.g. <code>HashMap</code>) and all the words of the
     * base name are considered to compute the variable names. A prefix and a suffix can be added to these names.<br>
     * There is a heuristic by variable kind.
     * <ul>
     * <li>{@link #VK_PARAMETER}, {@link #VK_LOCAL}, {@link #VK_INSTANCE_FIELD} and {@link #VK_STATIC_FIELD}:<br>
     ...
     * <li>{@link #VK_STATIC_FINAL_FIELD} :<br>
     * In this case a variable name will contain some words of the base name, all letters of the name will be converted to upper
     * case and segments will be separated by a underscore (<code>"_"</code>).<br>
     ...
     * </p>
     * <p>
     * For a complete description of these configurable options, see {@link JavaCore#getDefaultOptions()}. To programmatically
     * change these options, see {@link JavaCore#setOptions(java.util.Hashtable)} and
     ...
     *         {@link #VK_INSTANCE_FIELD} or {@link #VK_STATIC_FINAL_FIELD}.
     * @param baseNameKind
     *         specifies what type the base name is: {@link #BK_NAME} or {@link #BK_TYPE_NAME}
     * @param baseName
     *         name used to compute the suggested names.
     * @param javaProject
     *         project which contains the variable or <code>null</code> to take into account only workspace settings.
     * @param dim
     *         variable dimension (0 if the field is not an array).
     * @param excluded
     *         a list of names which cannot be suggested (already used names). Can be <code>null</code> if there are no
     *         excluded names.
     * @param evaluateDefault
     *         if <code>true</code>, the result is guaranteed to contain at least one result. If <code>false</code>,
     ...
     * @since 3.5
     */
    public static String[] suggestVariableNames(int variableKind, int baseNameKind, String baseName, int dim,
                                                String[] excluded, boolean evaluateDefault) {

        NamingRequestor requestor = new NamingRequestor();
        InternalNamingConventions.suggestVariableNames(variableKind, baseNameKind, baseName.toCharArray(), dim, null,
                                                       convertStringToChars(excluded), evaluateDefault, requestor);
