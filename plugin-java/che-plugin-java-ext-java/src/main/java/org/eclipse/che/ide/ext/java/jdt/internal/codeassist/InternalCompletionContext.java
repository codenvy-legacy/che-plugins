...
public class InternalCompletionContext extends CompletionContext {
    ...
    protected void setExtendedData(CompilationUnitDeclaration compilationUnitDeclaration,
                                   LookupEnvironment lookupEnvironment, Scope scope, ASTNode astNode, CompletionParser parser) {
        // TODO
        // this.isExtended = true;
    ...
    // /**
    // * Returns the innermost enclosing Java element which contains the completion location or <code>null</code> if this element
    // cannot be computed.
    // * The returned Java element and all Java elements in the same compilation unit which can be navigated to from the returned
    // Java element are special Java elements:
    // * <ul>
    // * <li>they are based on the current content of the compilation unit's buffer, they are not the result of a reconcile
    // operation</li>
    ...
    // * </ul>
    // *
    // * @return the innermost enclosing Java element which contains the completion location or <code>null</code> if this element
    // cannot be computed.
    // *
