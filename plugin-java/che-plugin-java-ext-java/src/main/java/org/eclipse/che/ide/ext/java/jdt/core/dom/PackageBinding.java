...
class PackageBinding implements IPackageBinding {
    ...
    private org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding binding;
    ...
    PackageBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding binding, BindingResolver resolver) {
    ...
    public IAnnotationBinding[] getAnnotations() {
        ...
        // org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding.addStandardAnnotations(binaryInstances, type.getTagBits(),
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding packageBinding2 = ((PackageBinding)other).binding;
