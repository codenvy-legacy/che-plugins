...
public class ParameterizedTypeBinding extends ReferenceBinding implements Substitution {
                ...
                for (int i = 0, length = typeVariables.length; i < length; i++) {
                    if (typeVariables[i].boundCheck(this, this.arguments[i]) != TypeConstants.OK) {
                        ...
                        if ((this.arguments[i].tagBits & TagBits.HasMissingType) == 0) {
                            ...
                            scope.problemReporter().typeMismatchError(this.arguments[i], typeVariables[i], this.type,
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#canBeInstantiated() */
    public boolean canBeInstantiated() {
        return ((this.tagBits & TagBits.HasDirectWildcard) == 0) && super.canBeInstantiated(); // cannot instantiate param type with
        // wildcard arguments
    }
     ...
     *
     * @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#capture(Scope, int)
     */
    public TypeBinding capture(Scope scope, int position) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (argument.kind() == Binding.WILDCARD_TYPE) { // no capture for intersection types
                capturedArguments[i] =
                        new CaptureBinding((WildcardBinding)argument, contextType, position, scope.compilationUnitScope()
                                                                                                  .nextCaptureID());
            } else {
        ...
        ParameterizedTypeBinding capturedParameterizedType =
                this.environment.createParameterizedType(this.type, capturedArguments, enclosingType());
        for (int i = 0; i < length; i++) {
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#collectMissingTypes(java.util.List) */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#computeId() */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#constantPoolName() */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#debugName() */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#enclosingType() */
    public ReferenceBinding enclosingType() {
        return this.enclosingType;
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.Substitution#environment() */
    public LookupEnvironment environment() {
        return this.environment;
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#erasure() */
    public TypeBinding erasure() {
        return this.type.erasure(); // erasure
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#fieldCount() */
    public int fieldCount() {
        return this.type.fieldCount(); // same as erasure (lazy)
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#fields() */
    public FieldBinding[] fields() {
    ...
    /**
     * Return the original generic type from which the parameterized type got instantiated from. This will perform lazy resolution
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#getAnnotationTagBits() */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#getExactConstructor(TypeBinding[]) */
    public MethodBinding getExactConstructor(TypeBinding[] argumentTypes) {
        ...
        if ((this.tagBits & TagBits.AreMethodsComplete) != 0) { // have resolved all arg types & return type of the methods
            ...
            nextMethod:
            for (int m = matchingMethods.length; --m >= 0; ) {
    ...
    /**
     * @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#getExactMethod(char[],
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#getField(char[], boolean) */
    public FieldBinding getField(char[] fieldName, boolean needResolve) {
        fields(); // ensure fields have been initialized... must create all at once unlike methods
        return ReferenceBinding.binarySearch(fieldName, this.fields);
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#getMemberType(char[]) */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#getMethods(char[]) */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#implementsMethod(MethodBinding) */
    ...
    void initialize(ReferenceBinding someType, TypeBinding[] someArguments) {
        ...
        // this.fields = null;
        // this.methods = null;
        this.modifiers = someType.modifiers & ~ExtraCompilerModifiers.AccGenericSignature; // discard generic signature, will
        // compute later
        ...
        if (someArguments != null) {
            ...
            for (int i = 0, length = someArguments.length; i < length; i++) {
                ...
                this.tagBits |=
                        someArgument.tagBits
                        & (TagBits.HasTypeVariable | TagBits.HasMissingType | TagBits.ContainsNestedTypeReferences);
            }
        }
        this.tagBits |=
                someType.tagBits
                & (TagBits.IsLocalType | TagBits.IsMemberType | TagBits.IsNestedType | TagBits.HasMissingType |
                   TagBits.ContainsNestedTypeReferences);
    ...
    public boolean isEquivalentTo(TypeBinding otherType) {
       ...
       * environment or not. See https://bugs.eclipse.org/bugs/show_bug.cgi?id=328827
       */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.Substitution#isRawSubstitution() */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#memberTypes() */
    public ReferenceBinding[] memberTypes() {
        if (this.memberTypes == null) {
            try {
                ...
                for (int i = 0; i < length; i++)
                    ...
                    parameterizedMemberTypes[i] =
               /*
                * isRaw && originalMemberTypes[i].isGenericType() ? this.environment.createRawType(originalMemberTypes[i], this) :
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#methods() */
    public MethodBinding[] methods() {
        if ((this.tagBits & TagBits.AreMethodsComplete) != 0)
            return this.methods;
     ...
     *
     * @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.Binding#problemId()
     */
    public int problemId() {
        return this.type.problemId();
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#qualifiedPackageName() */
    public char[] qualifiedPackageName() {
        return this.type.qualifiedPackageName();
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#qualifiedSourceName() */
    public char[] qualifiedSourceName() {
        return this.type.qualifiedSourceName();
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.Binding#readableName() */
    ...
    ReferenceBinding resolve() {
        ...
        ReferenceBinding resolvedType =
                (ReferenceBinding)BinaryTypeBinding.resolveType(this.type, this.environment, false /*
                                                                                             * no raw conversion
                                                                                             */); // still
        // part of
        // parameterized
        ...
        if (this.arguments != null) {
         ...
         /*
          * https://bugs.eclipse.org/bugs/show_bug.cgi?id=186565, Removed generic check and arity check since we are dealing with
          * binary types here and the fact that the compiler produced class files for these types at all is proof positive that
          * the generic check and the arity check passed in the build environment that produced these class files. Otherwise we
          * don't handle mixed 1.5 and 1.4 projects correctly. Just as with bounds check below, incremental build will propagate
          * the change and detect problems in source.
          */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.Binding#shortReadableName() */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#signature() */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding#sourceName() */
    public char[] sourceName() {
        return this.type.sourceName();
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.Substitution#substitute(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeVariableBinding) */
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#superclass() */
    public ReferenceBinding superclass() {
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#superInterfaces() */
    public ReferenceBinding[] superInterfaces() {
    ...
    public void swapUnresolved(UnresolvedReferenceBinding unresolvedType, ReferenceBinding resolvedType,
        ...
        if (this.type == unresolvedType) {
            ...
            if (enclosing != null) {
                this.enclosingType = (ReferenceBinding)env.convertUnresolvedBinaryToRawType(enclosing); // needed when binding
    ...
    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#syntheticEnclosingInstanceTypes() */
    public ReferenceBinding[] syntheticEnclosingInstanceTypes() {
        return genericType().syntheticEnclosingInstanceTypes();
    }

    /** @see org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.ReferenceBinding#syntheticOuterLocalVariables() */
