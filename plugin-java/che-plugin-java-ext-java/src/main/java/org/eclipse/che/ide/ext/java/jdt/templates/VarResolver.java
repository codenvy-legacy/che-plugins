...
public class VarResolver extends AbstractVariableResolver {
     ...
     */
    @Override
    protected CompilationUnitCompletion.Variable[] getVisibleVariables(String type, JavaContext context) {
        CompilationUnitCompletion.Variable[] localVariables = context.getLocalVariables(type);
        CompilationUnitCompletion.Variable[] fields = context.getFields(type);

        CompilationUnitCompletion.Variable[] result = new CompilationUnitCompletion.Variable[localVariables.length + fields.length];
