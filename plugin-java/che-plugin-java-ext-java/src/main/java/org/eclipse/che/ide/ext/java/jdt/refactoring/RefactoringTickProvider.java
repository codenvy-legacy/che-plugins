...
public class RefactoringTickProvider {
     ...
     *
     * @param checkInitialConditionsTicks
     *         ticks used in the initial condition
     *         check step
     * @param checkFinalConditionsTicks
     *         ticks used in the final condition
     *         check step
     * @param createChangeTicks
     *         ticks used in the create change step
     * @param initializeChangeTicks
     *         ticks used in the change validation steps
     */
    public RefactoringTickProvider(int checkInitialConditionsTicks, int checkFinalConditionsTicks,
                                   int createChangeTicks, int initializeChangeTicks) {
        Assert.isTrue(checkInitialConditionsTicks >= 0 && checkFinalConditionsTicks >= 0 && createChangeTicks >= 0
