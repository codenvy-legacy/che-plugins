...
public abstract class TType {
    ...
    public final boolean isHierarchyType() {
        ...
        return elementType == RAW_TYPE || elementType == PARAMETERIZED_TYPE || elementType == GENERIC_TYPE
     ...
     *
     * @param type
     *         The right hand side of the equals operation. The dynamic type
     ...
     *         if this type's TypeEnvironment
