...
class AnnotationBinding implements IAnnotationBinding {
    ...
    private org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding binding;

    private BindingResolver bindingResolver;

    private String key;

    AnnotationBinding(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding annotation,
    ...
    public IMemberValuePairBinding[] getAllMemberValuePairs() {
        ...
        for (int i = 0; i < methodLength; i++) {
            ...
            allPairs[i] =
                    pair == null ? new DefaultValuePairBinding(methods[i], this.bindingResolver)
