...
public class BreakStatement extends Statement {
     ...
     * @since 3.0
     */
    public static final ChildPropertyDescriptor LABEL_PROPERTY = new ChildPropertyDescriptor(BreakStatement.class,
                                                                                             "label", SimpleName.class, OPTIONAL,
    ...
    /**
     * Creates a new unparented break statement node owned by the given AST. By default, the break statement has no label.
     * <p>
    ...
    /**
     * Returns the label of this break statement, or <code>null</code> if there is none.
     *
     ...
     *
     * @param label
     *         the label, or <code>null</code> if there is none
