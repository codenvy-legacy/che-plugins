...
public abstract class Refactoring {
     ...
     */
    public RefactoringStatus checkAllConditions() throws CoreException, OperationCanceledException {
        RefactoringTickProvider refactoringTickProvider = getRefactoringTickProvider();
        RefactoringStatus result = new RefactoringStatus();
        result.merge(checkInitialConditions());
        if (!result.hasFatalError()) {
            result.merge(checkFinalConditions());
        }
        return result;
    }
     ...
     */
    public abstract RefactoringStatus checkInitialConditions() throws CoreException,
     ...
     * @see RefactoringStatus#FATAL
     */
    public abstract RefactoringStatus checkFinalConditions() throws CoreException,
                                                                    OperationCanceledException;
     ...
     *         if the condition checking got canceled
     */
    public abstract Change createChange() throws CoreException, OperationCanceledException;
