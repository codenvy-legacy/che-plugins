...
public abstract class Change {
     ...
     *
     * @param enabled
     *         <code>true</code> to enable this change; <code>
     ...
     *
     * @param parent
     *         the parent of this change or <code>null</code>
     */
   /* package */void setParent(Change parent) {
     ...
     */
    public abstract RefactoringStatus isValid() throws CoreException;
     ...
     */
    public abstract Change perform() throws CoreException;
