...
class MemberValuePairBinding implements IMemberValuePairBinding {
    ...
    static Object buildDOMValue(final Object internalObject, BindingResolver resolver) {
        ...
        } else if (internalObject instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding) {
            return resolver.getTypeBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)internalObject);
        } else if (internalObject instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding) {
            return resolver
                    .getAnnotationInstance((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding)internalObject);
        } else if (internalObject instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.FieldBinding) {
            return resolver
                    .getVariableBinding((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.FieldBinding)internalObject);
