...
public class ASTVisitorTest extends ParserBaseTest {
    ...
    private static class MethodDeclarationVisitor extends ASTVisitor {
        ...
        /** @see org.eclipse.che.ide.ext.java.jdt.core.dom.ASTVisitor#visit(org.eclipse.che.ide.ext.java.jdt.core.dom.MethodDeclaration) */
        @Override
    ...
    private static class TypeDeclarationVisitor extends ASTVisitor {
        ...
        /** @see org.eclipse.che.ide.ext.java.jdt.core.dom.ASTVisitor#visit(org.eclipse.che.ide.ext.java.jdt.core.dom.TypeDeclaration) */
        @Override
