...
public class AnnotationInfo extends ClassFileStruct implements IBinaryAnnotation {
     ...
     * @param populate
     *         <code>true</code> to indicate to build out the annotation structure.
     */
    ...
    Object decodeDefaultValue() {
        ...
        switch (tag) {
            ...
            case '@':
                value =
                        new AnnotationInfo(this.reference, this.constantPoolOffsets, this.readOffset + this.structOffset, false,
                                           true);
