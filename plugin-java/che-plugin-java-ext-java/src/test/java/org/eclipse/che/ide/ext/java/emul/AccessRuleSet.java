...
import org.eclipse.che.ide.ext.java.jdt.internal.compiler.env.AccessRule;
...
public class AccessRuleSet {
     ...
     *         one of {@link AccessRestriction#COMMAND_LINE},
    ...
    public boolean equals(Object object) {
        ...
        if (this.classpathEntryType != otherRuleSet.classpathEntryType || this.classpathEntryName == null
                                                                          && otherRuleSet.classpathEntryName != null ||
