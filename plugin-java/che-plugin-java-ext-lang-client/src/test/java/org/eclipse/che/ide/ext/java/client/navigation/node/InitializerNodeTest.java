...
public class InitializerNodeTest {
    ...
    public void setUp() throws Exception {
        ...
        initializerNode = new InitializerNode(resources, initializer, true, false, fileStructurePresenter);
    }
    ...
    public void presentationNameShouldBeUpdatedIfInheritedMemberHide() throws Exception {
        initializerNode = new InitializerNode(resources, initializer, false, false, fileStructurePresenter);
