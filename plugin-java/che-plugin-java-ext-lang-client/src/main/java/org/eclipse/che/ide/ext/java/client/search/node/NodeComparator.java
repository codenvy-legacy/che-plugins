...
/**
 * Comparator for nodes that has MatchNode as child.
 * Compares nodes according to match line number.
 *
...
public class NodeComparator implements Comparator<Node> {
    ...
    public int compare(Node o1, Node o2) {
        if (o1 instanceof MatchNode && o2 instanceof MatchNode) {
            return Integer.compare(((MatchNode)o1).getMatch().getMatchLineNumber(), ((MatchNode)o2).getMatch().getMatchLineNumber());
        }
