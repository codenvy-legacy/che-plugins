...
/**
 * The visual part of Preview view that has an ability to show preview information about the refactoring operation.
 *
...
interface PreviewView extends View<PreviewView.ActionDelegate> {
     ...
     *
     * @param changes
     *         list of changes from the refactoring operation
     */
