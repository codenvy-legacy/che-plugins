 ...
 */
public class ContentNode extends AbstractJavaSyntheticNode<JarEntry> implements VirtualFile, HasAction {

    @Inject
    public ContentNode(@Assisted JarEntry jarEntry,
    ...
    public Promise<String> getContent() {
        return AsyncPromiseHelper.createFromAsyncRequest(new AsyncPromiseHelper.RequestCall<String>() {
            ...
            public void makeCall(final AsyncCallback<String> callback) {
                nodeManager.getJavaService()
                           .getContent(getProjectDescriptor().getPath(), getData().getPath(),
