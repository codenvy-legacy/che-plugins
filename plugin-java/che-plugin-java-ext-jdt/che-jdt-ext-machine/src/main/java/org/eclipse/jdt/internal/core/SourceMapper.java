...
//			org.eclipse.jdt.internal.core.JavaModelManager manager = org.eclipse.jdt.internal.core.JavaModelManager.getJavaModelManager();
            ZipFile zip = null;
            try {
                zip = org.eclipse.jdt.internal.core.JavaModelManager.getJavaModelManager().getZipFile(pkgFragmentRootPath);
...
//											.validatePackageName(firstLevelPackageName, sourceLevel, complianceLevel);
                ...
                org.eclipse.jdt.internal.core.JavaModelManager.getJavaModelManager().closeZipFile(zip); // handle null case
            }
        } /*else {
