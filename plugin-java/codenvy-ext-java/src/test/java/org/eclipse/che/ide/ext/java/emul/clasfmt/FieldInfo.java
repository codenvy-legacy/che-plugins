...
public class FieldInfo extends ClassFileStruct implements IBinaryField, Comparable {
        ...
        if (numberOfAnnotations > 0) {
            ...
            for (int i = 0; i < numberOfAnnotations; i++) {
                ...
                AnnotationInfo newInfo =
                        new AnnotationInfo(this.reference, this.constantPoolOffsets, readOffset + this.structOffset,
    ...
    protected void toStringContent(StringBuffer buffer) {
        ...
        buffer.append('{')
                ...
                .append(getTypeName()).append(' ').append(getName()).append(' ').append(getConstant()).append('}').toString();
    }
}
