...
public class ASTRewritingMoveCodeTest extends ASTRewritingTest {
    ...
    public void testMoveDeclDifferentLevelCD() throws Exception {
...

        {
            ...
            { // move outer as inner of inner.
                ...
                rewrite.getListRewrite(innerType, TypeDeclaration.BODY_DECLARATIONS_PROPERTY).insertLast(insertNodeForCopy,
                                                                                                         null);
            ...
            { // copy method of inner to main type
                ...
                rewrite.getListRewrite(type, TypeDeclaration.BODY_DECLARATIONS_PROPERTY)
                       .insertLast(insertNodeForMove, null);
    ...
    public void testNestedCopies() throws Exception {
        ...
        CastExpression expression =
                (CastExpression)((VariableDeclarationFragment)varStat.fragments().get(0)).getInitializer();
