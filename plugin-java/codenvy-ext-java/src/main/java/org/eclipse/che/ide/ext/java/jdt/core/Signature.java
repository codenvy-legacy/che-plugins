 ...
 * <p>
 * Signatures obtained from parsing source files (i.e. files with one of the {@link JavaCore#getJavaLikeExtensions() Java-like
 * extensions}) differ subtly from ones obtained from pre-compiled binary (".class") files in class names are usually left
 * unresolved in the former. For example, the normal resolved form of the type "String" embeds the class's package name
 * ("Ljava.lang.String;" or "Ljava/lang/String;"), whereas the unresolved form contains only what is written "QString;".
 * </p>
 * <p>
 * Generic types introduce to the Java language in J2SE 1.5 add three new facets to signatures: type variables, parameterized
 * types with type arguments, and formal type parameters. <i>Rich</i> signatures containing these facets only occur when dealing
 * with code that makes overt use of the new language features. All other code, and certainly all Java code written or compiled
 ...
 * </p>
 * <p>
 * Note: An empty signature is considered to be syntactically incorrect. So most methods will throw an IllegalArgumentException if
 * an empty signature is provided.
 * </p>
 *
...
public final class Signature {
    ...
    /**
     * Scans the given string for an array type signature starting at the given index and appends it to the given buffer, and
     ...
     *         <code>true</code> if type names should be fully qualified, and <code>false</code> to use only
     *         simple names
    ...
    /**
     * Scans the given string for an capture type signature starting at the given index and appends it to the given buffer, and
     * returns the index of the last character.
     *
     * @param string
     *         the signature string
    ...
    /**
     * Scans the given string for a class type signature starting at the given index and appends it to the given buffer, and
     * returns the index of the last character.
     *
     * @param string
     *         the signature string
    ...
    /**
     * Scans the given string for an intersection type signature starting at the given index and appends it to the given buffer,
    ...
    /**
     * Scans the given string for a type argument signature starting at the given index and appends it to the given buffer, and
     * returns the index of the last character.
     *
     * @param string
     *         the signature string
    ...
    /**
     * Scans the given string for a list of type arguments signature starting at the given index and appends it to the given
    ...
    /**
     * Scans the given string for a type signature starting at the given index and appends it to the given buffer, and returns the
     ...
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException
     *         if this is not a type signature, or if isVarArgs is <code>true</code>, and the type is
     ...
     * <pre>
     * <code>
     * getQualifier({'j', 'a', 'v', 'a', '.', 'l', 'a', 'n', 'g', '.', 'O', 'b', 'j', 'e', 'c', 't'}) -> {'j', 'a', 'v', 'a', '.', 'l', 'a',
     * 'n', 'g'}
     * getQualifier({'O', 'u', 't', 'e', 'r', '.', 'I', 'n', 'n', 'e', 'r'}) -> {'O', 'u', 't', 'e', 'r'}
     * getQualifier({'j', 'a', 'v', 'a', '.', 'u', 't', 'i', 'l', '.', 'L', 'i', 's', 't', '<', 'j', 'a', 'v', 'a', '.', 'l', 'a', 'n', 'g',
     * '.', 'S', 't', 'r', 'i', 'n', 'g', '>'}) -> {'j', 'a', 'v', 'a', '.', 'u', 't', 'i', 'l'}
     * </code>
     * </pre>
     * </p>
     *
    ...
    /**
     * Returns a string containing all but the last segment of the given dot-separated qualified name. Returns the empty string if
     * it is not qualified.
     * <p>
     * For example:
     * <p/>
    ...
    /**
     * Returns package fragment of a type signature. The package fragment separator must be '.' and the type fragment separator
     * must be '$'.
     * <p>
     * For example:
     * <p/>
     * <pre>
     * <code>
     * getSignatureQualifier({'L', 'j', 'a', 'v', 'a', '.', 'u', 't', 'i', 'l', '.', 'M', 'a', 'p', '$', 'E', 'n', 't', 'r', 'y', ';'}) ->
     * {'j', 'a', 'v', 'a', '.', 'u', 't', 'i', 'l'}
     * </code>
     * </pre>
     * <p/>
    ...
    /**
     * Returns type fragment of a type signature. The package fragment separator must be '.' and the type fragment separator must
     * be '$'.
     * <p>
     * For example:
     * <p/>
     * <pre>
     * <code>
     * getSignatureSimpleName({'L', 'j', 'a', 'v', 'a', '.', 'u', 't', 'i', 'l', '.', 'M', 'a', 'p', '$', 'E', 'n', 't', 'r', 'y', ';'}) ->
     * {'M', 'a', 'p', '.', 'E', 'n', 't', 'r', 'y'}
     * </code>
     * </pre>
     * <p/>
     ...
     * <pre>
     * <code>
     * getSimpleNames({'j', 'a', 'v', 'a', '.', 'l', 'a', 'n', 'g', '.', 'O', 'b', 'j', 'e', 'c', 't'}) -> {{'j', 'a', 'v', 'a'}, {'l', 'a',
     * 'n', 'g'}, {'O', 'b', 'j', 'e', 'c', 't'}}
     * getSimpleNames({'O', 'b', 'j', 'e', 'c', 't'}) -> {{'O', 'b', 'j', 'e', 'c', 't'}}
     * getSimpleNames({}) -> {}
     * getSimpleNames({'j', 'a', 'v', 'a', '.', 'u', 't', 'i', 'l', '.', 'L', 'i', 's', 't', '<', 'j', 'a', 'v', 'a', '.', 'l', 'a', 'n',
     * 'g', '.', 'S', 't', 'r', 'i', 'n', 'g', '>'}) -> {{'j', 'a', 'v', 'a'}, {'l', 'a', 'n', 'g'}, {'L', 'i', 's', 't', '<', 'j', 'a',
     * 'v',
    ...
    /**
     * Returns all segments of the given dot-separated qualified name. Returns an array with only the given name if it is not
     * qualified. Returns an empty array if the name is empty.
     * <p/>
     * For example:
     * <p/>
     * <pre>
    ...
    /**
     * Extracts the thrown exception type signatures from the given method signature if any The method signature is expected to be
     * dot-based.
     *
     * @param methodSignature
     *         the method signature
    ...
    /**
     * Extracts the type argument signatures from the given type signature. Returns an empty array if the type signature is not a
    ...
    /**
     * Extracts the type erasure signature from the given parameterized type signature. Returns the given type signature if it is
     * not parameterized.
     *
     * @param parameterizedTypeSignature
     *         the parameterized type signature
    ...
    /**
     * Extracts the class and interface bounds from the given formal type parameter signature. The class bound, if present, is
     * listed before the interface bounds. The signature is expected to be dot-based.
     *
    ...
    /**
     * Extracts the type parameter signatures from the given method or type signature. The method or type signature is expected to
     * be dot-based.
     *
     ...
     * @return the kind of type signature; one of the kind constants: {@link #ARRAY_TYPE_SIGNATURE}, {@link #CLASS_TYPE_SIGNATURE},
     *         {@link #BASE_TYPE_SIGNATURE}, or {@link #TYPE_VARIABLE_SIGNATURE}, or (since 3.1) {@link #WILDCARD_TYPE_SIGNATURE}
     *         or {@link #CAPTURE_TYPE_SIGNATURE}, or (since 3.7) {@link #INTERSECTION_TYPE_SIGNATURE}
     * @throws IllegalArgumentException
     *         if this is not a type signature
     * @since 3.0
     */
    ...
    /**
     * Removes any capture information from the given type or method signature and returns the resulting signature. Returns the
     * type or method signature itself if no capture information is present.
     * <p>
     ...
     * @return a new signature without capture information or the signature itself if no specific capture information is present
     * @throws NullPointerException
     ...
     * <pre>
     * <code>
     * toString({'[', 'L', 'j', 'a', 'v', 'a', '.', 'l', 'a', 'n', 'g', '.', 'S', 't', 'r', 'i', 'n', 'g', ';'}) -> {'j', 'a', 'v', 'a',
     * '.',
     * 'l', 'a', 'n', 'g', '.', 'S', 't', 'r', 'i', 'n', 'g', '[', ']'}
     * toString({'I'}) -> {'i', 'n', 't'}
     * toString({'+', 'L', 'O', 'b', 'j', 'e', 'c', 't', ';'}) -> {'?', ' ', 'e', 'x', 't', 'e', 'n', 'd', 's', ' ', 'O', 'b', 'j', 'e',
     * 'c',
     * 't'}
     * </code>
     * </pre>
     ...
     * </p>
     * <p>
     * Note: This method assumes that a type signature containing a <code>'$'</code> is an inner type signature. While this is
     * correct in most cases, someone could define a non-inner type name containing a <code>'$'</code>. Handling this correctly in
     * all cases would have required resolving the signature, which generally not feasible.
     * </p>
     *
     * @param signature
     *         the type signature
     ...
     * <pre>
     * <code>
     * toQualifiedName({{'j', 'a', 'v', 'a'}, {'l', 'a', 'n', 'g'}, {'O', 'b', 'j', 'e', 'c', 't'}}) -> {'j', 'a', 'v', 'a', '.', 'l', 'a',
     * 'n', 'g', '.', 'O', 'b', 'j', 'e', 'c', 't'}
    ...
    public static String toString(String methodSignature, String methodName, String[] parameterNames,
        ...
        return new String(toCharArray(methodSignature.toCharArray(),
                                      methodName == null ? null : methodName.toCharArray(), params, fullyQualifyTypeNames,
                                      includeReturnType,
                                      isVarArgs));
    }
