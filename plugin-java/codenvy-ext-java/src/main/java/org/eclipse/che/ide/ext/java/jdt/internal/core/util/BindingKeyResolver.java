 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.java.jdt.internal.core.util;
...
public class BindingKeyResolver extends BindingKeyParser {
            ...
            if (CharOperation.equals(selector, method.selector) || (selector.length == 0 && method.isConstructor())) {
                ...
                if (CharOperation.equals(signature, methodSignature)) {
                    ...
                    PolymorphicMethodBinding polymorphicMethod =
                            this.environment.createPolymorphicMethod(method, parameterTypes);
                    this.methodBinding = polymorphicMethod;
                    this.methodBinding =
                            this.environment.updatePolymorphicMethodReturnType(polymorphicMethod,
    ...
    public void consumeParameterizedType(char[] simpleTypeName, boolean isRaw) {
        ...
        if (simpleTypeName != null) {
            ...
            if (!isRaw)
                this.typeBinding =
                        this.environment
                                .createParameterizedType(this.genericType, arguments, (ReferenceBinding)this.typeBinding);
            else
                // raw type
    ...
    public void consumeTopLevelType() {
        ...
        if (this.parsedUnit == null) {
            ...
            char[] typeName =
                    this.secondarySimpleName == null ? this.compoundName[this.compoundName.length - 1]
    ...
    private TypeBinding getTypeBinding(char[] simpleTypeName) {
        ...
        TypeDeclaration[] typeDeclarations =
                this.typeDeclaration == null ? (this.parsedUnit == null ? null : this.parsedUnit.types)
    ...
    public BindingKeyParser newParser() {
        return new BindingKeyResolver(this, this.compiler, this.environment, this.outerMostParsedUnit == null
                                                                             ? this.parsedUnit : this.outerMostParsedUnit,
                                      this.resolvedUnits);
    }
