...
public class SwitchStatement extends Statement {
    ...
    public static final ChildListPropertyDescriptor STATEMENTS_PROPERTY = new ChildListPropertyDescriptor(
            SwitchStatement.class, "statements", Statement.class, CYCLE_RISK); //$NON-NLS-1$
    ...
    /** The statements and SwitchCase nodes (element type: {@link Statement}). Defaults to an empty list. */
     ...
     * but legal, expression, and an empty list of switch groups.
     * <p>
    ...
    /**
     * Returns the live ordered list of statements for this switch statement. Within this list, <code>SwitchCase</code> nodes mark
     * the start of the switch groups.
     *
     * @return the live list of statement nodes (element type: {@link Statement})
     */
