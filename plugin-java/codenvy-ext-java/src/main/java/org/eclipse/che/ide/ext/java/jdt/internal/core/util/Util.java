                ...
                */
                    ...
                    if (next == ARGUMENTS_DELIMITER) {
                        ...
                        if (EMPTY_ARGUMENT.equals(currentArgumentContents)) {
                            currentArgumentContents = org.eclipse.che.ide.ext.java.jdt.internal.compiler.util.Util.EMPTY_STRING;
                        }
...
//        Log.error(Util.class, message, e);
    ...
    public static int scanTypeSignature(char[] string, int start) {
        ...
        return org.eclipse.che.ide.ext.java.jdt.internal.compiler.util.Util.scanTypeSignature(string, start);
    }
    ...
    static void appendTypeSignature(char[] string, int start, StringBuffer buffer, boolean compact) {
        ...
        switch (c) {
            ...
            case Signature.C_TYPE_VARIABLE:
                int e =
                        org.eclipse.che.ide.ext.java.jdt.internal.compiler.util.Util.scanTypeVariableSignature(string, start);
    ...
    public static String typeSignature(TypeReference type) {
        ...
        if ((type.bits & org.eclipse.che.ide.ext.java.jdt.internal.compiler.ast.ASTNode.IsUnionType) != 0) {
