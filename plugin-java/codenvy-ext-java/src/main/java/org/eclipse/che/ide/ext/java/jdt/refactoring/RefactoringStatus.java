...
public class RefactoringStatus {
     ...
     *
     * @param pluginId
     *         the entry's plug-in identifier
     * @param code
     *         the entry's code
     ...
     * @param pluginId
     *         the plug-in identifier. Can be <code>null</code> if argument <code>
     *         code</code> equals <code>NO_CODE</code>
     * @param code
     *         the problem code. Must be either <code>NO_CODE</code> or a positive integer
     * @param data
     *         application specific data
     * @return the newly created refactoring status
     * @see RefactoringStatusEntry
     */
    public static RefactoringStatus createStatus(int severity, String msg, RefactoringStatusContext context,
                                                 String pluginId, int code, Object data) {
     ...
     * @param pluginId
     *         the plug-in identifier of the entry. Can be <code>null</code> if
     ...
     *
     * @param entry
     *         the <code>RefactoringStatusEntry</code> to be added
     */
