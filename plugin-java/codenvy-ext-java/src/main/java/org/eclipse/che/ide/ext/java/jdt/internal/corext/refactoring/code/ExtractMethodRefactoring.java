...
//
//import org.eclipse.che.ide.java.client.core.dom.AST;
//import org.eclipse.che.ide.java.client.core.dom.ASTNode;
//import org.eclipse.che.ide.java.client.core.dom.ASTVisitor;
//import org.eclipse.che.ide.java.client.core.dom.AbstractTypeDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.AnnotationTypeDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.AnonymousClassDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.Assignment;
//import org.eclipse.che.ide.java.client.core.dom.Block;
//import org.eclipse.che.ide.java.client.core.dom.BodyDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.ChildListPropertyDescriptor;
//import org.eclipse.che.ide.java.client.core.dom.CompilationUnit;
//import org.eclipse.che.ide.java.client.core.dom.ContinueStatement;
//import org.eclipse.che.ide.java.client.core.dom.DoStatement;
//import org.eclipse.che.ide.java.client.core.dom.EnhancedForStatement;
//import org.eclipse.che.ide.java.client.core.dom.EnumDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.Expression;
//import org.eclipse.che.ide.java.client.core.dom.ExpressionStatement;
//import org.eclipse.che.ide.java.client.core.dom.FieldAccess;
//import org.eclipse.che.ide.java.client.core.dom.FieldDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.ForStatement;
//import org.eclipse.che.ide.java.client.core.dom.IMethodBinding;
//import org.eclipse.che.ide.java.client.core.dom.ITypeBinding;
//import org.eclipse.che.ide.java.client.core.dom.IVariableBinding;
//import org.eclipse.che.ide.java.client.core.dom.Initializer;
//import org.eclipse.che.ide.java.client.core.dom.Javadoc;
//import org.eclipse.che.ide.java.client.core.dom.LabeledStatement;
//import org.eclipse.che.ide.java.client.core.dom.MethodDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.MethodInvocation;
//import org.eclipse.che.ide.java.client.core.dom.Modifier;
//import org.eclipse.che.ide.java.client.core.dom.Name;
//import org.eclipse.che.ide.java.client.core.dom.ParenthesizedExpression;
//import org.eclipse.che.ide.java.client.core.dom.QualifiedName;
//import org.eclipse.che.ide.java.client.core.dom.ReturnStatement;
//import org.eclipse.che.ide.java.client.core.dom.SimpleName;
//import org.eclipse.che.ide.java.client.core.dom.SingleVariableDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.Statement;
//import org.eclipse.che.ide.java.client.core.dom.ThisExpression;
//import org.eclipse.che.ide.java.client.core.dom.Type;
//import org.eclipse.che.ide.java.client.core.dom.TypeDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.TypeParameter;
//import org.eclipse.che.ide.java.client.core.dom.VariableDeclaration;
//import org.eclipse.che.ide.java.client.core.dom.VariableDeclarationFragment;
//import org.eclipse.che.ide.java.client.core.dom.VariableDeclarationStatement;
//import org.eclipse.che.ide.java.client.core.dom.WhileStatement;
//import org.eclipse.che.ide.java.client.core.dom.rewrite.ASTRewrite;
//import org.eclipse.che.ide.java.client.core.dom.rewrite.ImportRewrite;
//import org.eclipse.che.ide.java.client.core.dom.rewrite.ImportRewrite.ImportRewriteContext;
//import org.eclipse.che.ide.java.client.core.dom.rewrite.ListRewrite;
//
//import org.eclipse.che.ide.java.client.internal.corext.codemanipulation.ContextSensitiveImportRewriteContext;
//import org.eclipse.che.ide.java.client.internal.corext.codemanipulation.StubUtility;
//import org.eclipse.che.ide.java.client.internal.corext.dom.ASTNodeFactory;
//import org.eclipse.che.ide.java.client.internal.corext.dom.ASTNodes;
//import org.eclipse.che.ide.java.client.internal.corext.dom.Bindings;
//import org.eclipse.che.ide.java.client.internal.corext.dom.BodyDeclarationRewrite;
//import org.eclipse.che.ide.java.client.internal.corext.dom.LinkedNodeFinder;
//import org.eclipse.che.ide.java.client.internal.corext.dom.Selection;
//import org.eclipse.che.ide.java.client.internal.corext.refactoring.ParameterInfo;
//import org.eclipse.che.ide.java.client.internal.corext.refactoring.RefactoringCoreMessages;
//import org.eclipse.che.ide.java.client.ltk.refactoring.Change;
//import org.eclipse.che.ide.java.client.ltk.refactoring.Refactoring;
//import org.eclipse.che.ide.java.client.ltk.refactoring.RefactoringStatus;
//import org.eclipse.che.ide.java.client.ltk.refactoring.TextFileChange;
//import org.eclipse.che.ide.java.client.runtime.CoreException;
//import org.eclipse.che.ide.java.client.runtime.IProgressMonitor;
//import org.eclipse.che.ide.java.client.runtime.OperationCanceledException;
//import org.eclipse.che.ide.editor.text.edits.MultiTextEdit;
//import org.eclipse.che.ide.editor.text.edits.TextEdit;
//import org.eclipse.che.ide.editor.text.edits.TextEditGroup;
//
///**
...
//            {
//               result.addError(Messages.format(RefactoringCoreMessages.ExtractMethodRefactoring_error_sameParameter,
...
//            new CompilationUnitChange(RefactoringCoreMessages.ExtractMethodRefactoring_change_name, fCUnit);
...
//            new TextEditGroup(Messages.format(RefactoringCoreMessages.ExtractMethodRefactoring_substitute_with_call,
...
//            new TextEditGroup(Messages.format(RefactoringCoreMessages.ExtractMethodRefactoring_add_method,
//               BasicElementLabels.getJavaElementName(fMethodName)));
...
//               RefactoringCoreMessages.ExtractMethodRefactoring_organize_imports, new TextEdit[]{edit}));
//         }
...
//                     new TextEditGroup(RefactoringCoreMessages.ExtractMethodRefactoring_replace_continue);
...
//      }
//      final int flags =
//         RefactoringDescriptor.STRUCTURAL_CHANGE | JavaRefactoringDescriptor.JAR_REFACTORING
//            | JavaRefactoringDescriptor.JAR_SOURCE_ATTACHMENT;
//      final String description =
//         Messages.format(RefactoringCoreMessages.ExtractMethodRefactoring_descriptor_description_short,
//            BasicElementLabels.getJavaElementName(fMethodName));
//      final String label =
//         method != null ? BindingLabelProvider.getBindingLabel(method, JavaElementLabels.ALL_FULLY_QUALIFIED)
...
//      comment.addSetting(Messages.format(RefactoringCoreMessages.ExtractMethodRefactoring_visibility_pattern,
//         visibility));
...
//         RefactoringSignatureDescriptorFactory.createExtractMethodDescriptor(project, description, comment.asString(),
//            arguments, flags);
...
//         boolean isVarargs =
//            declaration instanceof SingleVariableDeclaration ? ((SingleVariableDeclaration)declaration).isVarargs()
//               : false;
...
//   {
//      String type =
//         ASTNodes.asString(ASTNodeFactory.newType(declaration.getAST(), declaration, fImportRewriter,
...
//      if (numberOf == 1)
//         label =
//            Messages.format(RefactoringCoreMessages.ExtractMethodRefactoring_duplicates_single,
//               BasicElementLabels.getJavaElementName(fMethodName));
//      else
//         label =
//            Messages.format(RefactoringCoreMessages.ExtractMethodRefactoring_duplicates_multi,
//               BasicElementLabels.getJavaElementName(fMethodName));
//
...
//            (AbstractTypeDeclaration)ASTNodes.getParent(fAnalyzer.getEnclosingBodyDeclaration(),
//               AbstractTypeDeclaration.class);
//         String string =
//            CodeGeneration.getMethodComment(fCUnit, enclosingType.getName().getIdentifier(), result, null,
//               lineDelimiter);
//         if (string != null)
//         {
...
//            Modifier.isStatic(enclosingModifiers) || enclosingBodyDeclaration instanceof EnumDeclaration
...
//         }
//         fRewriter.replace(
//            selectedNodes[0].getParent() instanceof ParenthesizedExpression ? selectedNodes[0].getParent()
//               : selectedNodes[0], replacementNode, substitute);
//      }
//      else
//      {
...
//         {
//            ListRewrite source =
//               fRewriter.getListRewrite(selectedNodes[0].getParent(),
//                  (ChildListPropertyDescriptor)selectedNodes[0].getLocationInParent());
//            ASTNode toMove =
//               source.createMoveTarget(selectedNodes[0], selectedNodes[selectedNodes.length - 1], replacementNode,
//                  substitute);
...
//      result.setType(ASTNodeFactory.newType(fAST, original, fImportRewriter, new ContextSensitiveImportRewriteContext(
//         original, fImportRewriter)));
//      return result;
//   }
//
...
//      if (replace == null)
//         return RefactoringStatus.createFatalErrorStatus(Messages.format(
//            RefactoringCoreMessages.InitializableRefactoring_argument_not_exist, ATTRIBUTE_REPLACE));
//
...
//      if (comments == null)
//         return RefactoringStatus.createFatalErrorStatus(Messages.format(
//            RefactoringCoreMessages.InitializableRefactoring_argument_not_exist, ATTRIBUTE_COMMENTS));
//
...
//      if (exceptions == null)
//         return RefactoringStatus.createFatalErrorStatus(Messages.format(
//            RefactoringCoreMessages.InitializableRefactoring_argument_not_exist, ATTRIBUTE_EXCEPTIONS));
//
