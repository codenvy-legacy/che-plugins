...
public class ThisExpression extends Expression {
     ...
     * @since 3.0
     */
    public static final ChildPropertyDescriptor QUALIFIER_PROPERTY = new ChildPropertyDescriptor(ThisExpression.class,
    ...
    /**
     * Creates a new AST node for a "this" expression owned by the given AST. By default, there is no qualifier.
     *
     * @param ast
