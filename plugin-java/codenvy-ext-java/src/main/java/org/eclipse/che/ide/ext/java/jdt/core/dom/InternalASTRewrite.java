...
/**
 * Internal class: not intended to be used by client. When AST modifications recording is enabled, all changes are recorded by
 * this class.
 */
class InternalASTRewrite extends NodeEventHandler {
    ...
    // ASTRewriteAnalyzer visitor = new ASTRewriteAnalyzer(content, lineInfo, lineDelim, result, this.eventStore, this.nodeStore,
