...
public final class ArrayBinding extends TypeBinding {
    ...
    public static final FieldBinding ArrayLength = new FieldBinding(TypeConstants.LENGTH, TypeBinding.INT,
                                                                    ClassFileConstants.AccPublic | ClassFileConstants.AccFinal, null,
    ...
    public ArrayBinding(TypeBinding type, int dimensions, LookupEnvironment environment) {
        ...
        if (type instanceof UnresolvedReferenceBinding)
            ...
            this.tagBits |=
                    type.tagBits
                    & (TagBits.HasTypeVariable | TagBits.HasDirectWildcard | TagBits.HasMissingType | TagBits.ContainsNestedTypeReferences);
    }
