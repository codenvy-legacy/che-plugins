    ...
    public void updateFromParserState() {
        ...
        if (this.annotation == null && this.identifierPtr <= parser.identifierPtr) {
            ...
            if (this.hasPendingMemberValueName && this.identifierPtr < parser.identifierPtr) {
                ...
                SingleNameReference fakeExpression =
                        new SingleNameReference(RecoveryScanner.FAKE_IDENTIFIER, (((long)valueEnd + 1) << 32) + (valueEnd));
                    ...
                    if (parser.astPtr > -1 && parser.astStack[parser.astPtr] instanceof MemberValuePair) {
                        ...
                        if (argLength > 0) {
                            ...
                            if (pendingMemberValueName != null) {
                                ...
                                annotationEnd =
                                        lastMemberValuePair.value != null ? lastMemberValuePair.value instanceof Annotation
    ...
    public String toString(int tab) {
        if (this.annotation != null) {
            ...
            return tabString(tab)
                   + "Recovered annotation: identiferPtr=" + this.identifierPtr + " identiferlengthPtr=" + this.identifierLengthPtr +
