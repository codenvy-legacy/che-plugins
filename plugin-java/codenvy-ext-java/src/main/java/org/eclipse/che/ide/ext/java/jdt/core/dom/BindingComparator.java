...
class BindingComparator {
    ...
    static boolean isEqual(Binding declaringElement, Binding declaringElement2, HashSet visitedTypes) {
        if (declaringElement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding) {
            if (!(declaringElement2 instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)) {
                return false;
            }
            return isEqual((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)declaringElement,
                           (org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding)declaringElement2, visitedTypes);
        } else if (declaringElement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding) {
            if (!(declaringElement2 instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding)) {
                return false;
            }
            return isEqual((org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding)declaringElement,
                           (org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding)declaringElement2, visitedTypes);
        ...
        } else if (declaringElement instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding) {
            if (!(declaringElement2 instanceof org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding)) {
                return false;
            }
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding packageBinding =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding)declaringElement;
            org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding packageBinding2 =
                    (org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding)declaringElement2;
    ...
    static boolean isEqual(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding methodBinding,
                           org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding methodBinding2) {
        return isEqual(methodBinding, methodBinding2, new HashSet());
    }

    static boolean isEqual(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding methodBinding,
                           org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.MethodBinding methodBinding2, HashSet visitedTypes) {
    ...
    static boolean isEqual(VariableBinding variableBinding, VariableBinding variableBinding2) {
        return (variableBinding.modifiers & ExtraCompilerModifiers.AccJustFlag) ==
               ...
               && isEqual(variableBinding.type, variableBinding2.type) && (variableBinding.id == variableBinding2.id);
    }
     ...
     * @return true if both parameters are equals, false otherwise
     */
    static boolean isEqual(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding[] bindings,
                           org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding[] otherBindings) {
     ...
     */
    static boolean isEqual(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding[] bindings,
                           org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes) {
        if (bindings == null) {
            return otherBindings == null;
        }
        if (otherBindings == null) {
    ...
    static boolean isEqual(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding typeBinding,
                           org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes) {
        ...
        switch (typeBinding.kind()) {
            ...
            case Binding.PARAMETERIZED_TYPE:
                ...
                return CharOperation.equals(parameterizedTypeBinding.compoundName, parameterizedTypeBinding2.compoundName)
                       && (parameterizedTypeBinding.modifiers & (ExtraCompilerModifiers.AccJustFlag
                                                                 | ClassFileConstants.AccInterface | ClassFileConstants.AccEnum |
                                                                 ClassFileConstants.AccAnnotation)) ==
                          (parameterizedTypeBinding2.modifiers & (ExtraCompilerModifiers.AccJustFlag
                                                                  | ClassFileConstants.AccInterface | ClassFileConstants.AccEnum |
                                                                  ClassFileConstants.AccAnnotation))
            ...
            case Binding.GENERIC_TYPE:
                ...
                return CharOperation.equals(referenceBinding.compoundName, referenceBinding2.compoundName)
                       && (referenceBinding.modifiers & (ExtraCompilerModifiers.AccJustFlag | ClassFileConstants.AccInterface
                                                         | ClassFileConstants.AccEnum | ClassFileConstants.AccAnnotation)) ==
                          (referenceBinding2.modifiers & (ExtraCompilerModifiers.AccJustFlag
                                                          | ClassFileConstants.AccInterface | ClassFileConstants.AccEnum |
                                                          ClassFileConstants.AccAnnotation))
     ...
     */
    static boolean isEqual(org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding typeBinding,
                           org.eclipse.che.ide.ext.java.jdt.internal.compiler.lookup.TypeBinding typeBinding2) {
