...
public class BindingKeyParser {
    ...
    public static class Scanner {
        ...
        boolean isAtMemberTypeStart() {
            return this.index < this.source.length
                   && (this.source[this.index] == '$' || (this.source[this.index] == '.' && this.source[this.index - 1] == '>'));
        }
                ...
                switch (currentChar) {
                    ...
                    case 'Z':
                        ...
                        if (this.index == previousTokenEnd && (this.index == 0 || this.source[this.index - 1] !=
                                                                                  '.')) { // case of field or method starting with one of
                                                                                  // the character above
                            this.index++;
    ...
    private void parseInnerType() {
        ...
        if (Character.isDigit(typeName[0])) {
            ...
            typeName =
                    nextToken == Scanner.END ? this.scanner.source : CharOperation.subarray(this.scanner.source, this.keyStart,
