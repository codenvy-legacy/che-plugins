...
public abstract class AbstractVariableDeclaration extends Statement implements InvocationSite {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.lookup.InvocationSite#isSuperAccess()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.lookup.InvocationSite#isTypeAccess()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.lookup.InvocationSite#setActualReceiverType(org.eclipse.che.ide.java.client
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.lookup.InvocationSite#setDepth(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.eclipse.che.ide.java.client.internal.compiler.lookup.InvocationSite#setFieldIndex(int)
     */
    @Override
