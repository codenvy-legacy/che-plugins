...
/**
 * A simple lookup table is a non-synchronized Hashtable, whose keys and values are char[]. It also uses linear probing to resolve
 * collisions rather than a linked list of hash table entries.
 */
public final class SimpleSetOfCharArray implements Cloneable {
    ...
    public Object clone() {
        SimpleSetOfCharArray result = new SimpleSetOfCharArray();
