...
/**
 * Resolves template variables to variables which are assignment-compatible with the variable instance class parameters.
 *
 * @since 3.4
 */
public abstract class AbstractVariableResolver extends TemplateVariableResolver {
    ...
    /**
     * Create a variable resolver resolving to <code>defaultType</code> if no types specified as parameter
     *
     * @param defaultType
     *         the default type to resolve to
     */
     ...
     *
     * @param type
     *         the type name to search variables for
     * @param context
     *         context within to search for variables
