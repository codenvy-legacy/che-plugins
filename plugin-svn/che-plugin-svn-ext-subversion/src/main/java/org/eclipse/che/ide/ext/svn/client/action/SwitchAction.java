...
public class SwitchAction extends SubversionAction {
     ...
     */
    @Inject
    public SwitchAction(final AnalyticsEventLogger eventLogger,
                        final AppContext appContext,
                        final ProjectExplorerPresenter projectExplorerPresenter,
                        final SubversionExtensionLocalizationConstants constants,
                        final SubversionExtensionResources resources) {
        super(constants.switchTitle(), constants.switchDescription(), resources.switchLocation(), eventLogger,
