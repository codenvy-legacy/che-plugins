...
/**
 * JCE-based encrypt service which uses AES with PBKDF2WithHmacSHA1 (PBKDF2WithHmacSHA256 is only supported for java 8).
 */
public abstract class AESWithSHA1EncryptTextService extends JCEEncryptTextService {

    private static final String SECRETKEY_FACTORY_ALGORITHM = "PBKDF2WithHmacSHA1";
