...
import static org.eclipse.che.ide.ext.runner.client.tabs.console.button.ConsoleButtonImpl.TOP_TOOLTIP_SHIFT;
...
public class ConsoleButtonImplTest {
    ...
    public void setUp() throws Exception {
        ...
        widget = new ConsoleButtonImpl(resources, tooltip, SOME_MESSAGE, mock(SVGResource.class, RETURNS_MOCKS));
    }
