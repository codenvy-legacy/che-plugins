...
public class UploadSshKeyViewImpl extends Window implements UploadSshKeyView {
    ...
    @Inject
    public UploadSshKeyViewImpl(SshLocalizationConstant locale) {
        this.locale = locale;
        ...
        btnCancel = createButton(locale.cancelButton(), "gitSshKeys-cancel", new ClickHandler() {
        ...
        btnUpload = createButton(locale.uploadButton(), "gitSshKeys-upload", new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
