...
import static org.eclipse.che.ide.ext.ssh.client.manage.SshKeyManagerPresenter.GIT_SSH_SERVICE;
...
public class SshKeyManagerPresenterTest {
    ...
    public void testGo() {
        ...
        verify(service).getPairs(eq(GIT_SSH_SERVICE));
    ...
    public void testOnDeleteClickedWhenDeleteKeyConfirmed() {
        when(sshPairDto.getService()).thenReturn(GIT_SSH_SERVICE);
        ...
        verify(service).deletePair(eq(GIT_SSH_SERVICE), eq(GITHUB_HOST));
    }
    ...
    public void testOnDeleteClickedWhenDeleteKeyCanceled() {
        ...
        verify(confirmDialog).show();
        verify(service, never()).deletePair(eq(GIT_SSH_SERVICE), anyString());
    }
    ...
    public void testOnDeleteClickedWhenDeleteKeyIsFailure() throws OperationException {
        ...
        verify(confirmDialog).show();
        verify(service).deletePair(eq(GIT_SSH_SERVICE), anyString());
        verify(notificationManager).notify(anyString(), eq(StatusNotification.Status.FAIL), eq(true));
        verify(service, never()).getPairs(eq(GIT_SSH_SERVICE));
    }
    ...
    public void testOnGenerateClickedWhenUserConfirmGenerateKey() {
        ...
        verify(service).generatePair(eq(GIT_SSH_SERVICE), eq(GITHUB_HOST));
    }
    ...
    public void testOnGenerateClickedWhenUserCancelGenerateKey() {
        ...
        verify(service, never()).generatePair(eq(GIT_SSH_SERVICE), eq(GITHUB_HOST));
    }
