...
public class CheckoutReferencePresenter implements CheckoutReferenceView.ActionDelegate {
    ...
    private final Unmarshallable<ProjectDescriptor> unmarshaller;
    ...
    public CheckoutReferencePresenter(CheckoutReferenceView view,
        ...
        this.unmarshaller = dtoUnmarshallerFactory.newUnmarshaller(ProjectDescriptor.class);
    }
        ...
        service.branchCheckout(project,
                               ...
                               new AsyncRequestCallback<String>() {
                                   ...
                                   protected void onSuccess(String result) {
                                       ...
                                       projectService.getProject(projectPath, new AsyncRequestCallback<ProjectDescriptor>(unmarshaller) {
                                                   @Override
