 ...
 */
public class DirectiveCommentParser implements CodeCommentParser {

    private DtoFactory dtoFactory;

    private AngularTemplate angularTemplate;

    public DirectiveCommentParser(DtoFactory dtoFactory, AngularTemplate angularTemplate) {
    ...
    public AngularDocType getSupportedType() {
        return AngularDocType.DIRECTIVE;
    }
