...
/**
 * Testing {@link RubyValueProviderFactory} functionality.
 *
 * @author Roman Nikitenko.
 */
public class RubyValueProviderFactoryTest {
    private static final String workspace = "my_ws";

    private ProjectManager           pm;
    private RubyValueProviderFactory rubyValueProviderFactory;
    ...
    public void setUp() throws Exception {
        ...
        rubyValueProviderFactory = new RubyValueProviderFactory();
        projectTypes.add(new RubyProjectType(rubyValueProviderFactory));
    ...
    @Test
    public void testGetValuesWhenProjectContainsRubyFiles() throws Exception {
        Project rubyProject = pm.createProject(workspace, "rubyProject",
                                               new ProjectConfig("test project", "ruby", new HashMap<>(), null, null, null), null, null);
        FolderEntry baseFolder = rubyProject.getBaseFolder();
        baseFolder.createFile("test.rb", "test".getBytes(), MediaType.TEXT_PLAIN);

        List<String> values = rubyValueProviderFactory.newInstance(baseFolder).getValues(HAS_RUBY_FILES);
